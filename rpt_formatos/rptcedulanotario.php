...
<?php
	...
	$mynom = getNombreSocio($idsocio);
		...
		$thisdom = sociodom($idsocio);
			echo "<table border='0'  >
				...
				<tr>
					<td class='ths'>Direcci&oacute;n</td><td colspan='3'>$thisdom</td>
				</tr>
				<tr>
					<td class='ths'>R&eacute;gimen Matrimonial</td>
					<td>$rwy[22]</td>
				</tr>	
	...
	echo "<table  >
		...
		// garantias
		echo "<fieldset>
		<legend>| LISTA DE GARANTIAS RELACIONADAS CON EL CREDITO |</legend>
		";
	...
	// avales
		...
		echo "</fieldset>
		<fieldset>
		<legend>| LISTA DE AVALES RELACIONADOS CON EL CREDITO |</legend>
		";

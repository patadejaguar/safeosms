...
//=====================================================================================================
$xHP		= new cHPage("TR.CREDITOS POR MINISTRAR", HP_FORM);
$xQL		= new MQL();
$xLi		= new cSQLListas();
$xF			= new cFecha();
...
$xFRM		= new cHForm("frmcredsporministrar", "./");
$xSel		= new cHSelect();
...
$xHG->OButton("TR.MINISTRAR", "var xC=new CredGen();xC.getFormaMinistracion('+ data.record.numero_de_solicitud +')", "money.png");

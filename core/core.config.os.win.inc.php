...
$db_de_trabajo				= "coophon";					//Nombre de la Base de datos MySQL, se recomienda la misma que la sucursal
...
$V_cf1e8c14e54505f60aa10c	= "http://localhost/";	//Ruta HTTP del sistema

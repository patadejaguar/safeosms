...
if($credito and $credito!="0"){
	$filtro_extra = " AND creditos_solicitud.numero_solicitud = $credito ";
}
...
$input = $_GET["out"];
	...
	creditos_solicitud.periocidad_de_pago AS 'frecuencia', creditos_solicitud.saldo_actual AS 'saldo_insoluto',
	creditos_solicitud.fecha_ultimo_mvto, creditos_estatus.titulo_general AS 'estatus',

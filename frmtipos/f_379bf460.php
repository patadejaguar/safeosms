...
<window
        ...
        <grid flex="1">
            ...
            <rows>
                ...
                <row>
                    ...
                    <label value="Codigo" control="id-idcontable_centrodecostos" />
                    <textbox id="id-idcontable_centrodecostos" value="<?php echo $rw[0]; ?>"  size="10" maxlength="10" />
                    <label value="Nombre" control="id-nombre_centrodecostos" />
                    <textbox id="id-nombre_centrodecostos" value="<?php echo $rw[1]; ?>"  size="60" maxlength="60" />
                </row>
    ...
    function xul_find_record(){
       var xVal = prompt("Clave del Registro\r\nque desea buscar:   ", 0);
        document.getElementById("id-idcontable_centrodecostos").value = xVal;
        xul_get_record(); 
    }

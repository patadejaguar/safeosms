...
$xFRM->ODisabled_13("forma_de_creacion", $xTabla->forma_de_creacion()->v(), "TR.FORMA DE CREACION");
//$xFRM->OText("programacion", $xTabla->programacion()->v(), "TR.PROGRAMACION");
$xFRM->ODisabled_13("programacion", $xTabla->programacion()->v(), "TR.PROGRAMACION");
$xFRM->endSeccion();

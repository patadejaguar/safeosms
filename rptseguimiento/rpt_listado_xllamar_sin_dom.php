...
$input 			= $_GET["out"];
	...
	$sql_set .= " operaciones_tipos WHERE  creditos_solicitud.numero_socio=socios_general.codigo AND ";
	...
	$sql_set .= "HAVING nLetras=1 ORDER BY creditos_solicitud.numero_socio  LIMIT 0,500";
exit($setSql);

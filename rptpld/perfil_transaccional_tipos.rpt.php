...
$sql = "SELECT
	...
	`idpersonas_perfil_transaccional_tipos` AS `clave`,
	`personas_perfil_transaccional_tipos`.`nombre_del_perfil`                     
	AS `descripcion`,
	`personas_perfil_transaccional_tipos`.`tipo_de_exhibicion`,
	`personas_perfil_transaccional_tipos`.`afectacion`                            
	AS `tipo` 
FROM
	`personas_perfil_transaccional_tipos` `personas_perfil_transaccional_tipos` ";

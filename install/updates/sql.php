...
$sql["20180303"][]	= "INSERT INTO `personas_ae_scian` (`clave_interna`, `clave_de_actividad`, `nombre_de_la_actividad`, `clasificacion`, `clave_de_superior`) VALUES ('812990', '812990', 'EMPLEADOS, TRABAJADORES', 'CLASE', '812990')";
$sql["20180303"][]	= "UPDATE `personas_actividad_economica_tipos` SET `nombre_de_la_actividad` = 'Empleado / Obrero general (Migrado)' WHERE `clave_interna` = '10'";
$sql["20180303"][]	= "UPDATE `personas_actividad_economica_tipos` SET `nombre_de_la_actividad` = 'Empleado Administrativo (Migrado)' WHERE `clave_interna` = '11'";
$sql["20180303"][]	= "UPDATE `personas_actividad_economica_tipos` SET `nombre_de_la_actividad` = 'Agricultor / Ganadero (Migrado)' WHERE `clave_interna` = '40'";
$sql["20180303"][]	= "UPDATE `personas_actividad_economica_tipos` SET `nombre_de_la_actividad` = 'Empresario general (Migrado)' WHERE `clave_interna` = '50'";
$sql["20180303"][]	= "UPDATE `personas_actividad_economica_tipos` SET `nombre_de_la_actividad` = 'Actividad Por Asignar (Migrado)' WHERE `clave_interna` = '99'";
$sql["20180303"][]	= "INSERT INTO `personas_actividad_economica_tipos` (`clave_interna`, `clave_de_actividad`, `nombre_de_la_actividad`, `descripcion_detallada`, `productos`, `clasificacion`, `clave_de_superior`, `nivel_de_riesgo`, `califica_para_pep`) VALUES('980030901','9800309','Empleado / Obrero general (Migrado)','empleado_migrado','','CLASE','0','1','0')";
$sql["20180303"][]	= "INSERT INTO `personas_actividad_economica_tipos` (`clave_interna`, `clave_de_actividad`, `nombre_de_la_actividad`, `descripcion_detallada`, `productos`, `clasificacion`, `clave_de_superior`, `nivel_de_riesgo`, `califica_para_pep`) VALUES('980031001','9800310','Empleado Administrativo (Migrado)','administrativo_migrado','','CLASE','0','1','0')";
$sql["20180303"][]	= "INSERT INTO `personas_actividad_economica_tipos` (`clave_interna`, `clave_de_actividad`, `nombre_de_la_actividad`, `descripcion_detallada`, `productos`, `clasificacion`, `clave_de_superior`, `nivel_de_riesgo`, `califica_para_pep`) VALUES('010000801','0100008','Agricultor / Ganadero (Migrado)','agricultor_migrado','','CLASE','0','1','0')";
$sql["20180303"][]	= "INSERT INTO `personas_actividad_economica_tipos` (`clave_interna`, `clave_de_actividad`, `nombre_de_la_actividad`, `descripcion_detallada`, `productos`, `clasificacion`, `clave_de_superior`, `nivel_de_riesgo`, `califica_para_pep`) VALUES('842901201','8429012','Empresario general (Migrado)','empresario_migrado','','CLASE','0','1','0')";
$sql["20180303"][]	= "UPDATE `personas_ae_scian` SET `clave_aml` = '9800310' WHERE `clave_interna` = '812990'";
$sql["20180303"][]	= "INSERT INTO `personas_ae_scian` (`clave_interna`, `clave_de_actividad`, `nombre_de_la_actividad`, `clasificacion`, `clave_de_superior`, `clave_aml`) VALUES ('9506009', '812990', 'Estudiante, Desempleado, Jubilado, Pensionado, Discapacitado', 'CLASE', '812990', '9506009')";
$sql["20180303"][]	= "DELETE FROM `personas_actividad_economica_tipos` WHERE `clave_interna` = '842901201'";
$sql["20180303"][]	= "DELETE FROM `personas_actividad_economica_tipos` WHERE `clave_interna` = '10000801'";
$sql["20180303"][]	= "UPDATE `personas_actividad_economica_tipos` SET `nombre_de_la_actividad` = 'Empleado y Obrero general' , `descripcion_detallada` = '' , `scian` = '812990' WHERE `clave_interna` = '980030901'";
$sql["20180303"][]	= "UPDATE `personas_actividad_economica_tipos` SET `nombre_de_la_actividad` = 'Empleado Administrativo General' , `descripcion_detallada` = '' , `scian` = '812990' WHERE `clave_interna` = '980031001'";
$sql["20180303"][]	= "INSERT INTO `socios_aeconomica_tipos` (`idsocios_aeconomica_tipos`, `nombre_taeconomica`) VALUES ('980031001', 'Empleado Administrativo General')";
$sql["20180303"][]	= "INSERT INTO `socios_aeconomica_tipos` (`idsocios_aeconomica_tipos`, `nombre_taeconomica`) VALUES ('980030901', 'Empleado y Obrero general')";
$sql["20180303"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('36', 'suspension', 'Suspendido', 'usuarios_estatus')";
$sql["20180303"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('37', 'baja', 'En baja', 'usuarios_estatus')";
$sql["20180303"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('38', 'activo', 'Activo', 'usuarios_estatus')";
$sql["20180303"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('39', 'todas', 'Todas', 'usuarios_estatus')";
$sql["20180303"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9012', 'MSG_USER_EN_BAJA', '!Este usuario está en Baja!')";
$sql["20180303"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9013', 'MSG_USER_CONFIRM_BAJA', '¿Confirma la Baja de este Usuario?')";
$sql["20180303"][]	= "INSERT INTO `socios_tipoingreso` (`idsocios_tipoingreso`, `descripcion_tipoingreso`, `descripcion_detallada`) VALUES ('906', 'EMPRESA DE NOMINA', 'Empresa con contrato de nomia')";
$sql["20180303"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('100916', 'PERSONA_ES_FISICA', 'Es una Persona Fisica')";
$sql["20180303"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES ('18857', '18550', 'Carga de Traducciones', 'install/lang-upload.frm.php', 'Carga de Traducciones', 'fa-tasks', 'command', '18857', '18857', 'true')";

$sql["20180303"][]	= "SELECT setNuevoPermisoX('translate.frm.php')";
$sql["20180303"][]	= "SELECT setNuevoPermisoX('migrate-gpd1601.frm.php')";
$sql["20180303"][]	= "INSERT INTO `tesoreria_tipos_de_pago` (`tipo_de_pago`, `tipo_de_movimiento`, `descripcion`, `descripcion_completa`, `equivalente_aml`, `formato`, `eq_contable`) VALUES ('domiciliacion', '1', 'Cobro Domiciliado', 'Cobro desde bancos por Domiciliacion', '201', 'cobro-transferencia.frm.php', '9200')";
$sql["20180303"][]	= "SELECT setNuevoPermisoX('cotizador.frm.php')";
$sql["20180303"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('604', 'FORM', 'PERSONAS.PANEL_CON_FOTOS', '', '', '', '', '1')";
$sql["20180303"][]	= "SELECT setNuevoPermisoX('echale-purga.frm.php')";
$sql["20180303"][]	= "UPDATE `operaciones_tipos` SET `descripcion_operacion` = 'PAGO DEP. GTIA' , `descripcion` = 'Pago de Deposito en Garantia' , `nombre_corto` = 'DEP. GTIA.' WHERE `idoperaciones_tipos` = '901'";
$sql["20180303"][]	= "SELECT setNuevoPermisoX('creditos-garantias.new.frm.php')";
$sql["20180303"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('200922', 'CREDITO_FALTA_EMPRESA', 'El Crédito Requiere un Empleador Válido.')";

$sql["20180401"][]	= "SELECT setNuevoPermisoX('empresas.new.frm.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('tesoreria.pagos.svc.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('empresas.edit.frm.php')";
$sql["20180401"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('605', 'FORM', 'CREDITOS.NOMINA.FORZAR.PAGO', '', '', '', '')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('envio-nomina-recibos.rpt.php')";
$sql["20180401"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('606', 'SYSTEM', 'RECIBOS.RESTAURAR_LETRA', '', '', '', '', '1')";
$sql["20180401"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES ('2015', '2010', 'Panel de Grupos', 'frmgrupos/grupos.panel.frm.php', 'Panel de Control de Grupos', 'fa.users', 'command', '1', '2015', 'true')";
$sql["20180401"][]	= "ALTER TABLE `empresas_cobranza` CHANGE COLUMN `parcialidad` `parcialidad` INT(6) NULL DEFAULT '0' ,ADD COLUMN `monto_arch` DOUBLE(12,2) NULL DEFAULT '0' AFTER `tiempocobro`";
$sql["20180401"][]	= "UPDATE `empresas_cobranza` SET  `monto_arch` = `monto_enviado`";
$sql["20180401"][]	= "ALTER TABLE `creditos_plan_de_pagos` ADD COLUMN `estatusactivo` INT(2) NULL DEFAULT '1' AFTER `total_c_castigos`";

$sql["20180401"][]	= "SELECT setNuevoPermisoX('nom-letras-envios.svc.php')";
$sql["20180401"][]	= "INSERT INTO `general_contratos` (`idgeneral_contratos`, `tipo_contrato`, `titulo_del_contrato`, `texto_del_contrato`) VALUES ('902', '900', 'Mail.- Envio de Nomina', '<!-- Contenido -->') ";
$sql["20180401"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('1006', 'MSG_CONFIRMA_ENVIO', '¿ Confirma el Envio ?')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('cotizador.plan.rpt.php')";
$sql["20180401"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9014', 'MSG_CONFIRM_ADD_GPO', '¿ Confirma asociar la persona al Grupo ?')";
$sql["20180401"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9015', 'MSG_CONFIRM_ADD_EMP', '¿ Confirma asociar la persona a la Empresa ?')";
$sql["20180401"][]	= "CREATE TABLE IF NOT EXISTS `originacion_grupos` ( `originacion_grupos_id` INT NOT NULL AUTO_INCREMENT,  `grupo_id` BIGINT(20) NULL DEFAULT 0,  `nivel_id` INT(4) NULL DEFAULT 1,  `estatusactivo` INT(2) NULL DEFAULT 1,  `tiempo` INT NULL DEFAULT 0,  `presidenta_id` BIGINT(20) NULL DEFAULT 0,  `fecha_solicitud` DATE NULL,  `idusuario` INT(8) NULL DEFAULT 0,  `fecha_autorizacion` DATE NULL,  `suma_solicitado` DOUBLE(18,2) NULL DEFAULT 0,  `suma_autorizado` DOUBLE(18,2) NULL DEFAULT 0,  PRIMARY KEY (`originacion_grupos_id`)) ENGINE = InnoDB ";
$sql["20180401"][]	= "CREATE TABLE IF NOT EXISTS `grupos_solicitud` ( `grupos_solicitud_id` INT NOT NULL AUTO_INCREMENT,  `originacion_grupos_id` INT NULL DEFAULT 0,  `grupo_id` BIGINT(20) NULL DEFAULT 0,  `persona_id` BIGINT(20) NULL DEFAULT 1,  `tiempo` INT NULL DEFAULT 0,  `idusuario` INT(8) NULL DEFAULT 0,  `monto_solicitado` DOUBLE(16,2) NULL DEFAULT 0,  `monto_autorizado` DOUBLE(16,2) NULL DEFAULT 0,  `razon_rechazo_id` INT(4) NULL DEFAULT '1', PRIMARY KEY (`grupos_solicitud_id`)) ENGINE = InnoDB";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('grupos-add-solicitud.frm.php')";
$sql["20180401"][]	= "CREATE TABLE IF NOT EXISTS `personas_aports_tipos` (  `personas_aports_tipos_id` INT NOT NULL,  `operacion_tipo_id` INT(4) NULL DEFAULT 0,  `tasa_rendimiento` FLOAT(6,3) NULL DEFAULT 0,  `pagadero` INT(4) NULL DEFAULT 30 COMMENT 'periodicidad de pago',  PRIMARY KEY (`personas_aports_tipos_id`)) ENGINE = InnoDB";
$sql["20180401"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES (20516, 2050, 'Municipios', 'frmtipos/municipios.frm.php', 'Municipios', 'fa-list-alt', 'command', '20516', '20516', 'true') ";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('municipios.new.frm.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('municipios.edit.frm.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('entidadesfederales.new.frm.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('entidadesfederales.edit.frm.php')";
$sql["20180401"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES (20517, 2050, 'Estados', 'frmtipos/entidadesfederales.frm.php', 'Estados', 'fa-list-alt', 'command', '20517', '20517', 'true') ";
$sql["20180401"][]	= "INSERT INTO `general_niveles` (`idgeneral_niveles`, `descripcion_del_nivel`, `task_events`, `work_time_range`, `rules_by_user`, `tipo_sistema`) VALUES ('72', 'Oficial de seguimiento', '', '', 'PUEDE_EDITAR_USUARIOS=false;PUEDE_AGREGAR_USUARIOS=false;PUEDE_ELIMINAR_RECIBOS=false;', '4')";
$sql["20180401"][]	= "INSERT INTO `general_niveles` (`idgeneral_niveles`, `descripcion_del_nivel`, `task_events`, `work_time_range`, `rules_by_user`, `tipo_sistema`) VALUES ('73', 'Oficial de Seg. Suc.', '', '', 'PUEDE_EDITAR_USUARIOS=false;PUEDE_AGREGAR_USUARIOS=false;PUEDE_ELIMINAR_RECIBOS=false;', '4')";
$sql["20180401"][]	= "UPDATE `general_menu` SET `menu_rules`=CONCAT(`menu_rules`, ',73@rw') WHERE FIND_IN_SET('73@rw',`menu_rules`) = 0 AND FIND_IN_SET('71@rw',`menu_rules`) > 0";
$sql["20180401"][]	= "UPDATE `general_menu` SET `menu_rules`=CONCAT(`menu_rules`, ',72@rw') WHERE FIND_IN_SET('72@rw',`menu_rules`) = 0 AND FIND_IN_SET('71@rw',`menu_rules`) > 0";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('cotizador.edit.frm.php')";
$sql["20180401"][]	= "ALTER TABLE `creditos_rechazados` ADD COLUMN `tiempo` INT(11) NULL DEFAULT '0' AFTER `idusuario`,ADD COLUMN `estatusactivo` INT(2) NULL DEFAULT '1' AFTER `tiempo`";
$sql["20180401"][]	= "INSERT INTO `creditos_rechazos_tipo` (`idcreditos_rechazos_tipo`, `descripcion`) VALUES ('50', 'Credito Duplicado')";
$sql["20180401"][]	= "INSERT INTO `creditos_rechazos_tipo` (`idcreditos_rechazos_tipo`, `descripcion`) VALUES ('51', 'Credito Cancelado por el Cliente')";
$sql["20180401"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('40', 'common', 'Eventos Normales', 'cat_error_clases')";
$sql["20180401"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('41', 'security', 'Eventos de Seguridad', 'cat_error_clases')";
$sql["20180401"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('42', 'developer', 'Eventos de Depurado', 'cat_error_clases')";
$sql["20180401"][]	= "UPDATE `general_reports` SET `idgeneral_reports` = '../rptsecurity/acumulado_de_incidencias.rpt.php?' WHERE `idreport` = '147'";
$sql["20180401"][]	= "UPDATE `general_reports` SET `idgeneral_reports` = '../rptsecurity/rpt_system_log.php?' WHERE `idreport` = '148'";

$sql["20180401"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('200923', 'CREDITO_FALTA_DRENOV', 'El Credito debe tener los Datos de Renovacion.')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('creditos.datos-origen.frm.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('creditos.datos-origen.new.frm.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('creditos.datos-origen.edit.frm.php')";
$sql["20180401"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES (4034, 4030, 'Creditos datos de Originacion', 'frmorigen/creditos.datos-origen.frm.php', 'Creditos datos de Originacion', 'fa-list-alt', 'command', '4034', '4034', 'true') ";
$sql["20180401"][]	= "UPDATE `general_menu` SET `menu_file` = 'frmcreditos/creditos.datos-origen.frm.php' WHERE `idgeneral_menu` = '4034'";
$sql["20180401"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('200924', 'CREDITO_FALTA_DREEST', 'El Credito debe tener datos de Reestructura.')";
$sql["20180401"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('607', 'FORM', 'RECIBOS.COBROS_DATO_EXTRA', '', '', '', '')";
$sql["20180401"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES (20518, 2050, 'Tipo de Aportacion', 'frmsocios/aportaciones-tipos.frm.php', 'Tipo de Aportacion', 'fa-list-alt', 'command', '20518', '20518', 'true') ";
$sql["20180401"][]	= "ALTER TABLE `personas_aports_tipos` ADD COLUMN `estatusactivo` INT(2) NULL DEFAULT '1' AFTER `pagadero`";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('aportaciones-tipos.edit.frm.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('aportaciones-tipos.new.frm.php')";
$sql["20180401"][]	= "ALTER TABLE `personas_aports_tipos` CHANGE COLUMN `personas_aports_tipos_id` `personas_aports_tipos_id` INT(11) NOT NULL AUTO_INCREMENT";
$sql["20180401"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('608', 'FORM', 'RECIBOS.APORT_SOC_COMP', '', '', '', '', '1')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('forma.vista_previa.rpt.php')";
$sql["20180401"][]	= "INSERT INTO `tesoreria_monedas` (`clave_de_moneda`, `nombre_de_la_moneda`, `quivalencia_en_moneda_local`, `pais_de_origen`, `simbolo`) VALUES ('AKZ', 'KWANZA', '1', 'AO', 'KZ')";
$sql["20180401"][]	= "INSERT INTO `tesoreria_monedas` (`clave_de_moneda`, `nombre_de_la_moneda`, `quivalencia_en_moneda_local`, `pais_de_origen`, `simbolo`) VALUES ('AOA', 'AOA-KWANZA', '1', 'AO', 'KZ')";
$sql["20180401"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9016', 'MSG_CONFIRMA_COBRO', '¿ Confirma el cobro de estos conceptos ?')";
$sql["20180401"][]	= "CREATE TABLE IF NOT EXISTS `personas_share` ( `personas_share` INT NOT NULL AUTO_INCREMENT,  `persona_id` BIGINT(25) NULL,  `personas_share_id` BIGINT(25) NULL,  `tiempo` INT(11) NULL DEFAULT 0,  `url_share` VARCHAR(150) NULL DEFAULT '', `idusuario` INT(8) NULL DEFAULT '0', PRIMARY KEY (`personas_share`)) ENGINE = INNODB ";
$sql["20180401"][]	= "ALTER TABLE `personas_share` CHANGE `personas_share` `idpersonas_share` INT(11) NOT NULL AUTO_INCREMENT";
$sql["20180401"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('2008', 'MSG_TAREA_OK', '¡ Tarea terminada con exito !')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('importar.svc.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('exportar.svc.php')";
$sql["20180401"][]	= "SELECT setNuevoPermisoX('contrato.css.php')";
...
$sql["20180501"][]	= "UPDATE `catalogos_localidades` SET `nombre_de_la_localidad` = CONCAT(UCASE(LEFT(`nombre_de_la_localidad`, 1)), LCASE(SUBSTRING(`nombre_de_la_localidad`, 2)))";


$sql["20180501"][]	= "SELECT setNuevoPermisoX('cartera-gtia-liquida.frm.php')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('1','ALERTA DE DESPEDIDOS','SYS_ALERTA_POR_EVENTO','NOMINA.AL_DESPEDIR','CORREO:pruebas@opencorebanking.com|','{fecha}-{hora}\r\nLa persona {nombre_de_persona} ha sido Despedido de {nombre_de_la_empresa}. \r\nNotas: {mensaje}\r\nCredito con Saldo: {saldo_del_credito}.\r\n{usuario}\r\n',',SMS,MAIL','','')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('2','ALERTA DE DESVINCULADOS','SYS_ALERTA_POR_EVENTO','NOMINA.AL_DESVINCULAR','CORREO:pruebas@opencorebanking.com|','{fecha}-{hora}\r\nLa persona {nombre_de_persona} ha sido quitado de la nomina de {nombre_de_la_empresa}. \r\nNotas: {mensaje}\r\nCredito con Saldo: {saldo_del_credito}.\r\n{usuario}\r\n',',SMS,MAIL','','')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('3','ENVIO DE CORTES DE CAJA','SYS_ALERTA_POR_EVENTO','CAJA.AL_CERRAR','CORREO:pruebas@opencorebanking.com|','Envio automatico de cortes',',SMS,MAIL','','rpttesoreria/corte_de_caja.rpt.php?dependencia=todas&cajero={clave_de_usuario}&on={fecha}&off={fecha}')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('4','ENVIO DE REPORTE COBRANZA PENDIENTE','SYS_ALERTA_AL_CIERRE','PROGRAMACION_DIARIA','CORREO:pruebas@opencorebanking.com|','',',MAIL','','rptcreditos/parcialidades_pendientes.rpt.php?producto=200&on={fecha_dia_siguiente}&off={fecha_dia_siguiente}&out=default')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('5','CREDITOS MINISTRADOS UN DIA EN COMUN','SYS_ALERTA_AL_CIERRE','PROGRAMACION_DIARIA','CORREO:pruebas@opencorebanking.com|','',',MAIL','','rptcreditos/creditos360-ministrados_en_dia_comun.rpt.php?on={fecha_dia_siguiente}&off={fecha_dia_siguiente}&out=default')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('7','CREDITOS OTORGADOS EN LA SEMANA','SYS_ALERTA_AL_CIERRE','PROGRAMACION_DIARIA','CORREO:pruebas@opencorebanking.com|','',',MAIL','','rptoperaciones/operaciones.nomina.php?on={fecha_inicio_de_semana}&off={fecha}&estado=todas&out=xml&empresa=todas&convenio=todas&tipodepago=todas&usuario=todas&tipooperacion=110&cuentabancaria=todas')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('8','ACUMULADO MENSUAL DE INGRESOS POR EMPRESAS','SYS_ALERTA_Al_CIERRE','PROGRAMACION_DIARIA','CORREO:pruebas@opencorebanking.com|','',',MAIL','','rptoperaciones/ingresos.acumulado.empresas.rpt.php?on={fecha_inicio_de_mes}&off={fecha}&estado=todas&out=default&empresa=todas&convenio=todas&tipodepago=transferencia&usuario=todas&tipooperacion=todas&cuentabancaria=todas')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('9','INGRESOS POR CREDITOS SIMPLES','SYS_ALERTA_AL_CIERRE','PROGRAMACION_DIARIA','CORREO:pruebas@opencorebanking.com|','',',MAIL','','rptoperaciones/ingresos.acumulado.personas.rpt.php?on={fecha_inicio_de_mes}&off={fecha}&estado=todas&out=default&empresa=todas&convenio=200&tipodepago=transferencia&usuario=todas&tipooperacion=todas&cuentabancaria=todas')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('10','ALERTA ELIMINAR RECIBO','SYS_ALERTA_POR_EVENTO','DATA.AL.ELIMINAR.RECIBO','CORREO:pruebas@opencorebanking.com|','{mensaje}\r\n\r\n{original}',',MAIL','',NULL)";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('11','AVISO DE MINISTRACION','SYS_ALERTA_POR_EVENTO','CREDITOS.MINISTRAR','CORREO:pruebas@opencorebanking.com|','{fecha}. El usuario {usuario} genero la Ministracion del Credito {clave_de_credito} con monto de $ {monto_de_credito} perteneciente a la persona ({clave_de_persona}) {nombre_de_persona}. Autorizado como {tipo_de_autorizacion}.','','','')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('12','AVISO DE LIQUIDACION','SYS_ALERTA_POR_EVENTO','CREDITOS.CUANDO_SE_LIQUIDAN','CORREO:pruebas@opencorebanking.com|','{fecha}-{hora}\r\nSe ha liquidado el Credito con codigo de {codigo} descrito como {descripcion} de la persona {nombre_de_persona} en la empresa {nombre_de_la_empresa}. \r\n{usuario}\r\n',',MAIL','','')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('13','AVISO DE VINCULACION','SYS_ALERTA_POR_EVENTO','NOMINA.AL_VINCULAR','CORREO:pruebas@opencorebanking.com|','{fecha}-{hora}\r\nEl Credito con codigo de {codigo} descrito como {descripcion} de la persona {nombre_de_persona} a sido VINCULADO a la empresa {nombre_de_la_empresa}. \r\n{usuario}\r\n',',MAIL','','')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('14','RESPALDOAL ELIMINAR RECIBO','SYS_ALERTA_POR_EVENTO','DATA.ANTES.ELIMINAR.RECIBO','CORREO:pruebas@opencorebanking.com|','{mensaje}\r\n\r\n{original}',',MAIL','','rpt_formatos/recibo.rpt.php?recibo={idrecibo}&mail={mail}')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('16','CREDITOS.CUANDO_SE_AUTORIZA','SYS_ALERTA_POR_EVENTO','CREDITOS.CUANDO_SE_AUTORIZA','CORREO:pruebas@opencorebanking.com|','{fecha}-{hora}\r\nEl Credito {clave_de_credito} de la persona {nombre_de_persona} ha sido autorizado por {vars_creds_monto_autorizado}.',',MAIL','','')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('15','PRECREDITOS.NUEVO_REGISTRO','SYS_ALERTA_POR_EVENTO','PROGRAMACION_DIARIA','CORREO:pruebas@opencorebanking.com|','',',MAIL','','')";
$sql["20180501"][]	= "insert into `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) values('500','ESTADO DE CUENTA','SYS_ALERTA_POR_EVENTO','CREDITOS.CUANDO_EDOCTA_EXEC','CORREO:pruebas@opencorebanking.com|','',',MAIL','','rpt_edos_cuenta/rptestadocuentacredito.php?credito={credito}&mail={email}')";
$sql["20180501"][]	= "INSERT INTO `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) VALUES ('121', 'CREDITOS.CUANDO_SE_RECHAZA', 'SYS_ALERTA_POR_EVENTO', 'CREDITOS.CUANDO_SE_RECHAZA', 'CORREO:pruebas@opencorebanking.com|', 'La solicitud de credito {clave_de_credito} de la persona {nombre_de_persona} ha sido rechazado.', ',MAIL', '', '')";
$sql["20180501"][]	= "INSERT INTO `sistema_programacion_de_avisos` (`idprograma`, `nombre_del_aviso`, `forma_de_creacion`, `programacion`, `destinatarios`, `microformato`, `tipo_de_medios`, `intent_check`, `intent_command`) VALUES ('120', 'RECIBOS.GARANTIA_LIQUIDA_DEV', 'SYS_ALERTA_POR_EVENTO', 'RECIBOS.GARANTIA_LIQUIDA_DEV', 'CORREO:pruebas@opencorebanking.com|', '{fecha}. El usuario {usuario} genero la devolucion de Garantia liquida del credito {clave_de_credito} de la persona {nombre_de_persona}.', ',MAIL', '', '')";
$sql["20180501"][]	= "UPDATE `general_utilerias` SET `isdisabled` = 'true' WHERE `idgeneral_utilerias` = '837'";
$sql["20180501"][]	= "INSERT INTO `general_utilerias` (`idgeneral_utilerias`, `nombre_utilerias`, `descripcion_utileria`, `describe_param_1`, `describe_param_2`) VALUES ('502', 'Operaciones.- Eliminar Recibos en un rango de Fechas', 'Eliminar recibos y Operaciones en un rango de fecha', 'FECHA_INICIAL', 'FECHA_FINAL')";
$sql["20180501"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('612', 'SYSTEM', 'CREDITOS.DEV.INT_NORMAL.VENCIDO', '', '', '', '', '1')";
$sql["20180501"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('613', 'SYSTEM', 'CREDITOS.AUTOPURGAR.MINIMOS', '', '', '', '')";
$sql["20180501"][]	= "ALTER TABLE `personas_documentacion_tipos` ADD COLUMN `es_ident` INT(2) NULL DEFAULT '0' AFTER `estatus` ";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '210'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '220'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '230'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '2201'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '2202'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '2203'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '2204'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '2205'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '2206'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `estatus` = '0' WHERE `clave_de_control` = '210'";
$sql["20180501"][]	= " UPDATE `personas_documentacion_tipos` SET `estatus` = '0' WHERE `clave_de_control` = '220'";
...
$sql["20180503"][]	= "ALTER TABLE `general_log` ADD COLUMN `iddocumento` BIGINT(20) NULL DEFAULT '0' AFTER `idpersona`,ADD COLUMN `idrecibo` BIGINT(20) NULL DEFAULT '0' AFTER `iddocumento` ";
$sql["20180503"][]	= "UPDATE `socios_estatus` SET `nombre_estatus` = 'Activo' WHERE `tipo_estatus` = '10'";
$sql["20180503"][]	= "UPDATE `socios_estatus` SET `nombre_estatus` = 'Baja' WHERE `tipo_estatus` = '20'";
$sql["20180503"][]	= "UPDATE `socios_estatus` SET `nombre_estatus` = 'Registrado' WHERE `tipo_estatus` = '99'";
$sql["20180503"][]	= "UPDATE `socios_estadocivil` SET `descripcion_estadocivil` = 'Casado(a)' WHERE `idsocios_estadocivil` = '1'";
$sql["20180503"][]	= "UPDATE `socios_estadocivil` SET `descripcion_estadocivil` = 'Soltero(a)' WHERE `idsocios_estadocivil` = '2'";
$sql["20180503"][]	= "UPDATE `socios_estadocivil` SET `descripcion_estadocivil` = 'Divorciado(a)' WHERE `idsocios_estadocivil` = '3'";
$sql["20180503"][]	= "UPDATE `socios_estadocivil` SET `descripcion_estadocivil` = 'Union Libre' WHERE `idsocios_estadocivil` = '4'";
$sql["20180503"][]	= "UPDATE `socios_estadocivil` SET `descripcion_estadocivil` = 'No especifica' WHERE `idsocios_estadocivil` = '5'";
$sql["20180503"][]	= "UPDATE `socios_estadocivil` SET `descripcion_estadocivil` = 'Viudo(a)' WHERE `idsocios_estadocivil` = '6'";
$sql["20180503"][]	= "UPDATE `socios_estadocivil` SET `descripcion_estadocivil` = 'Separado(a)' WHERE `idsocios_estadocivil` = '7'";
$sql["20180503"][]	= "UPDATE `socios_estadocivil` SET `descripcion_estadocivil` = 'No Clasificado' WHERE `idsocios_estadocivil` = '99'";

$sql["20180801"][]	= "UPDATE `socios_genero` SET `descripcion_genero` = 'Femenino' WHERE `idsocios_genero` = '2'";
$sql["20180801"][]	= "UPDATE `socios_genero` SET `descripcion_genero` = 'Masculino' WHERE `idsocios_genero` = '1'";
$sql["20180801"][]	= "UPDATE `socios_genero` SET `descripcion_genero` = 'No declarado' WHERE `idsocios_genero` = '99'";
$sql["20180801"][]	= "ALTER TABLE `socios_aeconomica` ADD COLUMN `principal` INT(2) NULL DEFAULT '0' AFTER `descripcion` ";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Aval Hipotecarion' WHERE `idsocios_relacionestipos` = '52'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Aval Quirografario' WHERE `idsocios_relacionestipos` = '51'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Beneficiario' WHERE `idsocios_relacionestipos` = '11'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Conyuge' WHERE `idsocios_relacionestipos` = '3'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Integrante de Grupo' WHERE `idsocios_relacionestipos` = '96'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Mancomunante' WHERE `idsocios_relacionestipos` = '70'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Sin clasificar' WHERE `idsocios_relacionestipos` = '99'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Propietario Real' WHERE `idsocios_relacionestipos` = '552'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Proveedor de Recursos' WHERE `idsocios_relacionestipos` = '551'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Referencia Bancaria' WHERE `idsocios_relacionestipos` = '22'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Referencia Comercial' WHERE `idsocios_relacionestipos` = '23'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Referencia Personal' WHERE `idsocios_relacionestipos` = '21'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Representante de Grupo' WHERE `idsocios_relacionestipos` = '97'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Representante Legal' WHERE `idsocios_relacionestipos` = '14'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Representante Legal Mancomunado' WHERE `idsocios_relacionestipos` = '15'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Resp. Solidario / Copropietario' WHERE `idsocios_relacionestipos` = '12'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Resp. Solidario / Copropietario en Cred.' WHERE `idsocios_relacionestipos` = '53'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Tutor / Apoderado Legal' WHERE `idsocios_relacionestipos` = '13'";
$sql["20180801"][]	= "UPDATE `socios_relacionestipos` SET `descripcion_relacionestipos` = 'Vocal de Vigilancia de Grupo' WHERE `idsocios_relacionestipos` = '98'"; 
$sql["20180801"][]	= "INSERT INTO `general_reports` (`idgeneral_reports`, `descripcion_reports`, `aplica`, `idreport`, `explicacion`, `order_index`) VALUES ('../rptcajaslocales/rpt_socios_xcajalocal_v2.php?', 'Clientes.- Informacion de persona y creditos', 'cajalocal', '1201', '', '1201') ";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('local.css.php')";
$sql["20180801"][]	= "UPDATE `creditos_estatus` SET `descripcion_estatus` = 'Vigente' , `titulo_general` = 'Vigente' WHERE `idcreditos_estatus` = '10'";
$sql["20180801"][]	= "UPDATE `creditos_estatus` SET `descripcion_estatus` = 'Vencido' , `titulo_general` = 'Vencido' WHERE `idcreditos_estatus` = '20'";
$sql["20180801"][]	= "UPDATE `creditos_estatus` SET `descripcion_estatus` = 'Con Atraso' , `titulo_general` = 'Vigente' WHERE `idcreditos_estatus` = '30'";
$sql["20180801"][]	= "UPDATE `creditos_estatus` SET `descripcion_estatus` = 'Castigado' , `titulo_general` = 'Baja' WHERE `idcreditos_estatus` = '50'";
$sql["20180801"][]	= "UPDATE `creditos_estatus` SET `descripcion_estatus` = 'Autorizado' , `titulo_general` = 'En Proceso' WHERE `idcreditos_estatus` = '98'";
$sql["20180801"][]	= "UPDATE `creditos_estatus` SET `descripcion_estatus` = 'Solicitado' , `titulo_general` = 'En Proceso' WHERE `idcreditos_estatus` = '99'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Diario' WHERE `idcreditos_periocidadpagos` = '1'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Semanal' WHERE `idcreditos_periocidadpagos` = '7'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Decenal' WHERE `idcreditos_periocidadpagos` = '10'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Catorcenal' WHERE `idcreditos_periocidadpagos` = '14'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Quincenal' WHERE `idcreditos_periocidadpagos` = '15'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Mensual' WHERE `idcreditos_periocidadpagos` = '30'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Bimestral' WHERE `idcreditos_periocidadpagos` = '60'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Trimestral' WHERE `idcreditos_periocidadpagos` = '90'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'No Asignado' WHERE `idcreditos_periocidadpagos` = '99'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Cuatrimestral' WHERE `idcreditos_periocidadpagos` = '120'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Semestral' WHERE `idcreditos_periocidadpagos` = '180'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Final de Pzo.' WHERE `idcreditos_periocidadpagos` = '360'";
$sql["20180801"][]	= "UPDATE `creditos_periocidadpagos` SET `descripcion_periocidadpagos` = 'Anual' WHERE `idcreditos_periocidadpagos` = '365'";
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('2501', 'MSG_WARN_DEL_INFO_ANT', 'Eliminara Informacion anterior.')";
$sql["20180801"][]	= "ALTER TABLE  `socios_general` CHANGE COLUMN `xclasificacion` `xclasificacion` INT(4) NULL DEFAULT '1' ,CHANGE COLUMN `yclasificacion` `yclasificacion` INT(4) NULL DEFAULT '1' ,CHANGE COLUMN `zclasificacion` `zclasificacion` INT(4) NULL DEFAULT '1' ";
$sql["20180801"][]	= "UPDATE `socios_general` SET `xclasificacion`=1 WHERE `xclasificacion`=0";
$sql["20180801"][]	= "UPDATE `socios_general` SET `yclasificacion`=1 WHERE `yclasificacion`=0";
$sql["20180801"][]	= "UPDATE `socios_general` SET `zclasificacion`=1 WHERE `zclasificacion`=0";
$sql["20180801"][]	= "UPDATE `socios_general` SET `grupo_solidario`=99 WHERE `grupo_solidario`!=99 AND (SELECT COUNT(*) FROM `socios_grupossolidarios` WHERE `idsocios_grupossolidarios`=`socios_general`.`grupo_solidario`)=0";
$sql["20180801"][]	= "ALTER TABLE `socios_general` CHANGE `dependencia` `dependencia` INT(4) UNSIGNED DEFAULT 99 NOT NULL";
$sql["20180801"][]	= "INSERT INTO `general_reports` (`idgeneral_reports`, `descripcion_reports`, `aplica`, `idreport`, `explicacion`, `order_index`) VALUES ('../rptcajaslocales/rpt_socios_xcajalocal_v21.php?', 'Clientes.- Informacion de persona y creditos detalle', 'cajalocal', '1202', '', '1202')";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('rpt_socios_xcajalocal_v2.php')";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('rpt_socios_xcajalocal_v21.php')";
$sql["20180801"][]	= "INSERT INTO `personas_documentacion_tipos` (`clave_de_control`, `nombre_del_documento`, `clasificacion`, `vigencia_dias`, `almacen`, `estatus`) VALUES ('1', 'No Identificado', 'DG', '1', '0', '0')";
$sql["20180801"][]	= "INSERT INTO `personas_documentacion_tipos` (`clave_de_control`, `nombre_del_documento`, `clasificacion`, `vigencia_dias`, `almacen`, `estatus`) VALUES ('99', 'No Identificado', 'DG', '1', '0', '0')";
$sql["20180801"][]	= "ALTER TABLE `creditos_lineas` CHANGE `estado` `estado` INT(4) UNSIGNED DEFAULT 1 NOT NULL COMMENT '1 Vigente 0 Cancelado'";
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('2011', 'CREDITO_NO_MAYOR', 'El Monto del Credito sobrepasa el Limite establecido.') ";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('creditos-lineas.panel.frm.php')";
$sql["20180801"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('614', 'SYSTEM', 'AML.NO.CONSULTAR.WIKI', '', '', '', '', '1')";
$sql["20180801"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('615', 'FORM', 'RECIBOS.CON.VENDEDOR', '', '', '', '', '1')";
$sql["20180801"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('616', 'FORM', 'RECIBOS.CON.RECIBO_FISCAL', '', '', '', '')";
$sql["20180801"][]	= "UPDATE `tesoreria_cajas_movimientos` SET `banco` = (SELECT `entidad_bancaria` FROM `bancos_cuentas` WHERE `idbancos_cuentas`=`tesoreria_cajas_movimientos`.`cuenta_bancaria` LIMIT 0,1) WHERE `cuenta_bancaria`>0";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('cobro-domiciliado.frm.php')";
$sql["20180801"][]	= "UPDATE `tesoreria_tipos_de_pago` SET `formato` = 'cobro-domiciliado.frm.php' WHERE `tipo_de_pago` = 'domiciliacion'";
$sql["20180801"][]	= "ALTER TABLE `personas_datos_extranjero`  CHANGE `clave_de_persona` `clave_de_persona` BIGINT(25) UNSIGNED NOT NULL";
$sql["20180801"][]	= "ALTER TABLE `personas_perfil_transaccional` CHANGE `clave_de_persona` `clave_de_persona` BIGINT(20) UNSIGNED DEFAULT 1 NULL";
$sql["20180801"][]	= "ALTER TABLE `personas_aseguradoras` CHANGE `persona` `persona` BIGINT(20) UNSIGNED NULL";
$sql["20180801"][]	= "ALTER TABLE `personas_checklist` CHANGE `clave_de_persona` `clave_de_persona` BIGINT(20) UNSIGNED DEFAULT 0 NOT NULL";
$sql["20180801"][]	= "CREATE TABLE IF NOT EXISTS `creditos_pagos_esp` (  `idcreditos_pagos_esp` INT NOT NULL AUTO_INCREMENT,  `credito` BIGINT(20) NULL,  `periodo` INT(6) NULL,  `monto_esp` DOUBLE(16,2) NULL DEFAULT '0',  PRIMARY KEY (`idcreditos_pagos_esp`)) ENGINE = InnoDB";
$sql["20180801"][]	= "UPDATE `general_contratos` SET `texto_del_contrato` = 'Sr(a). variable_persona_nombre_completo se le recuerda su pago pendiente por variable_notificacion_total.' WHERE `idgeneral_contratos` = '3001'";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('tareas')";
$sql["20180801"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('617', 'SYSTEM', 'CREDITOS.360.COMOLETRAS', '', '', '', '', '1')";
$sql["20180801"][]	= "INSERT INTO `general_contratos` (`idgeneral_contratos`, `tipo_contrato`, `titulo_del_contrato`, `texto_del_contrato`) VALUES ('3003', '120', 'SMS Recordatorio Pago', 'Sr(a). variable_persona_nombre_completo se le recuerda su pago por variable_notificacion_total vence el variable_notificacion_vencimiento.') ";

$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('43', 'default', 'Ver en Pantalla', 'rpt_tipos_salida')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('44', 'pdf', 'Archivo PDF', 'rpt_tipos_salida')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('45', 'xls', 'Excel (xls)', 'rpt_tipos_salida')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('46', 'csv', 'Separado por coma (csv)', 'rpt_tipos_salida')";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('utilerias-catalogo.edit.frm.php')";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('idioma-catalogo.edit.frm.php')";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('idioma-catalogo.new.frm.php')";
$sql["20180801"][]	= "UPDATE `general_menu` SET `menu_file` = 'frmsystem/utilerias-catalogo.frm.php' , `menu_type` = 'command' , `menu_help_id` = '11202' WHERE `idgeneral_menu` = '11202'";
$sql["20180801"][]	= "UPDATE `general_menu` SET `menu_file` = 'frmsystem/idioma-catalogo.frm.php' , `menu_description` = 'Palabras por Idioma' , `menu_image` = 'fa-language' , `menu_help_id` = '11204' , `menu_showin_toolbar` = 'true' WHERE `idgeneral_menu` = '11204'";
$sql["20180801"][]	= "UPDATE `general_menu` SET `menu_title` = 'Catalogo de Palabras' WHERE `idgeneral_menu` = '11204'";
$sql["20180801"][]	= "UPDATE `general_menu` SET `menu_title` = 'Catalogo de Formulas' , `menu_file` = 'frmsystem/formulas-catalogo.frm.php' , `menu_description` = 'Catalogo CRUD de Formulas' , `menu_image` = 'fa-superscript' , `menu_help_id` = '11205' WHERE `idgeneral_menu` = '11205'"; 
$sql["20180801"][]	= "CREATE TABLE IF NOT EXISTS `contratos_log` ( `idcontratos_log` INT NOT NULL AUTO_INCREMENT,  `persona` BIGINT(20) NULL DEFAULT '1',  `credito` BIGINT(20) NULL DEFAULT '1',  `recibo` VARCHAR(50) NULL DEFAULT '1',  `idevento` INT(6) NULL DEFAULT '1',  `idusuario` INT(8) NULL DEFAULT '1',  `tiempo` INT(11) NULL DEFAULT '0',  `mensaje` VARCHAR(250) NULL DEFAULT '',  PRIMARY KEY (`idcontratos_log`)) ENGINE = InnoDB";
$sql["20180801"][]	= "ALTER TABLE `socios_general` ADD COLUMN `idejecutivo` INT(6) NULL DEFAULT '99' AFTER `nss`";
$sql["20180801"][]	= "UPDATE `socios_general` SET `idejecutivo`=`idusuario`";
$sql["20180801"][]	= "ALTER TABLE `sistema_programacion_de_avisos` ADD COLUMN `estatus` INT(2) NULL DEFAULT '1' AFTER `intent_command`";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('1052', 'Credito Castigado', 'common')";
$sql["20180801"][]	= "ALTER TABLE `socios_memotipos` ADD COLUMN `estatus` INT(2) NULL DEFAULT '1' AFTER `descripcion_memo`";
$sql["20180801"][]	= "INSERT INTO  `socios_memotipos` (`tipo_memo`, `descripcion_memo`) VALUES ('15', 'Nota de Castigo')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('91', 'Nuevo Permiso Agregado', 'security')";
$sql["20180801"][]	= "ALTER TABLE `general_niveles` ADD COLUMN `estatus` INT(2) NULL DEFAULT '1' AFTER `tipo_sistema`";
$sql["20180801"][]	= "INSERT INTO `general_niveles` (`idgeneral_niveles`, `descripcion_del_nivel`, `task_events`, `work_time_range`, `rules_by_user`, `initpage`, `taskspage`, `tipo_sistema`) VALUES ('12', 'Usuario 12', '', '', '', 'index.xul.php', 'utils/frm_calendar_tasks.php', '1')";
$sql["20180801"][]	= "INSERT INTO `general_niveles` (`idgeneral_niveles`, `descripcion_del_nivel`, `task_events`, `work_time_range`, `rules_by_user`, `initpage`, `taskspage`, `tipo_sistema`) VALUES ('11', 'Usuario 11', '', '', '', 'index.xul.php', 'utils/frm_calendar_tasks.php', '1')";
$sql["20180801"][]	= "UPDATE `general_niveles` SET `estatus` = '0' WHERE `idgeneral_niveles` = '11'";
$sql["20180801"][]	= "UPDATE `general_niveles` SET `estatus` = '0' WHERE `idgeneral_niveles` = '12'";
$sql["20180801"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('618', 'SYSTEM', 'RN_NO_USAR_CHAT_AYUDA', '', '', '', '')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20001', 'Credito Registrado', 'common')";
$sql["20180801"][]	= "UPDATE `personas_documentacion_tipos` SET `es_ident` = '1' WHERE `clave_de_control` = '3201' ";
$sql["20180801"][]	= "UPDATE `general_log` SET `type_error`=501 WHERE `text_log` LIKE '%Se Fallo al Agregar la Operacion%' ";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('501', 'Operacion No Agregada', 'common')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('1053', 'Credito Actualizado', 'common')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20012', 'Credito No Autorizado', 'common')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20013', 'Credito Autorizado', 'common')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20014', 'Credito Rechazado', 'common')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20015', 'Credito Cancelado Sin Operar', 'common')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20016', 'Credito Cancelado Operando', 'common')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20017', 'Aval vinculado', 'common')";
$sql["20180801"][]	= "UPDATE `sistema_programacion_de_avisos` SET `tipo_de_medios` = ',MAIL' WHERE `idprograma` = '11'";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20018', 'Credito Ministrado', 'common')";
$sql["20180801"][]	= "CREATE TABLE IF NOT EXISTS `creditos_productos_reglas` (`idcreditos_productos_reglas` INT NOT NULL AUTO_INCREMENT,`producto_id` INT(6) NULL,`tipo_regla` INT(4) NULL DEFAULT '0' COMMENT '1 nivel',`clave_Interna` VARCHAR(10) NULL DEFAULT '',`evoluciona` INT(2) NULL DEFAULT '1' COMMENT '1 nivel',`contador` INT(4) NULL DEFAULT '0',`num_minimo` INT(8) NULL DEFAULT '0',`num_maximo` INT(8) NULL DEFAULT '0',`monto_min` DOUBLE(18,2) NULL DEFAULT '0',`monto_max` DOUBLE(18,2) NULL DEFAULT '0',`tasa_min` FLOAT(6,3) NULL DEFAULT '0', `tasa_max` FLOAT(6,3) NULL DEFAULT '0', PRIMARY KEY (`idcreditos_productos_reglas`)) ENGINE = InnoDB ";
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('4498', 'RECIBO_NO_EXISTE', 'El Recibo No Existe')";
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('4497', 'RECIBO_EN_ARCHIVO', 'El recibo existe en Archivados.')";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('sistema-log.fix.frm.php')";
$sql["20180801"][]	= "ALTER TABLE `creditos_productos_reglas` ADD COLUMN `sujeto` VARCHAR(60) NULL DEFAULT '' AFTER `tasa_max`";
$sql["20180801"][]	= "ALTER TABLE `sistema_catalogo` CHANGE COLUMN `clave` `clave` VARCHAR(20) NULL DEFAULT NULL ";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('47', '1', 'Valor o Rango', 'cpdtos_t_regla')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('48', '1', 'Valor estandar', 'cpdtos_t_evolucion')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('49', '2', 'Nivel', 'cpdtos_t_evolucion')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('50', 'TASA_INTERES', 'Tasa de Interes', 'cpdtos_t_sujetos')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('51', 'TASA_MORATORIO', 'Tasa de Mora', 'cpdtos_t_sujetos')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('52', 'PERIODICIDAD', 'Periodicidad de Pago', 'cpdtos_t_sujetos')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('53', 'PAGOS', 'Numero de Pagos', 'cpdtos_t_sujetos')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('54', 'MONTO_CREDITO', 'Monto Autorizado', 'cpdtos_t_sujetos')";
$sql["20180801"][]	= "INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('55', 'TIPO_CUOTA', 'Tipo de Cuota', 'cpdtos_t_sujetos')";
$sql["20180801"][]	= "ALTER TABLE `personas_regimen_fiscal` ADD COLUMN `iva_exento` INT(2) NULL DEFAULT '1' AFTER `nombre_legal`";
$sql["20180801"][]	= " UPDATE `personas_regimen_fiscal` SET `iva_exento` = '0' WHERE `clave_de_regimen` = '100'";
$sql["20180801"][]	= " UPDATE `personas_regimen_fiscal` SET `iva_exento` = '0' WHERE `clave_de_regimen` = '13'";
$sql["20180801"][]	= " UPDATE `personas_regimen_fiscal` SET `iva_exento` = '0' WHERE `clave_de_regimen` = '12'";
$sql["20180801"][]	= " UPDATE `personas_regimen_fiscal` SET `iva_exento` = '0' WHERE `clave_de_regimen` = '11'";
$sql["20180801"][]	= " UPDATE `personas_regimen_fiscal` SET `iva_exento` = '0' WHERE `clave_de_regimen` = '1'";
$sql["20180801"][]	= " UPDATE `personas_regimen_fiscal` SET `iva_exento` = '0' WHERE `clave_de_regimen` = '201'";
$sql["20180801"][]	= " UPDATE `personas_regimen_fiscal` SET `iva_exento` = '0' WHERE `clave_de_regimen` = '202'";
$sql["20180801"][]	= " UPDATE `personas_regimen_fiscal` SET `iva_exento` = '0' WHERE `clave_de_regimen` = '203'"; 
$sql["20180801"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES (3032, 3030, 'Periodicidad de Flujo', 'frmcreditos/periodicidad_de_flujo.frm.php', 'Periodicidad de Flujo', 'fa-list-alt', 'command', '3032', '3032', 'true') ";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('periodicidad_de_flujo.edit.frm.php')";
$sql["20180801"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES (3037, 3030, 'Tipos de Cuota', 'frmcreditos/creditos.tipo_de_cuota.frm.php', 'Tipos de Cuota', 'fa-list-alt', 'command', '3035', '3035', 'true') ";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('creditos.tipo_de_cuota.edit.frm.php')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20019', 'Plan de Pagos Generado', 'common')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20020', 'Cambio de Estatus', 'common')";
$sql["20180801"][]	= "UPDATE `general_error_codigos` SET `description_error` = 'Evento no Catalogado' WHERE `idgeneral_error_codigos` = '9001'";
$sql["20180801"][]	= "ALTER TABLE `personas_perfil_transaccional` ADD COLUMN `idusuario` INT(8) NULL DEFAULT '0' AFTER `res_aplicacion_id`";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('creditos.productos.panel.frm.php')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('1054', 'Producto de Credito Modificado', 'common') ";
$sql["20180801"][]	= " INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('56', '0', 'Ninguno', 'cpdtos_tipo_sistema')";
$sql["20180801"][]	= " INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('57', '100', 'Nomina', 'cpdtos_tipo_sistema')";
$sql["20180801"][]	= " INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('58', '200', 'Individuales', 'cpdtos_tipo_sistema')";
$sql["20180801"][]	= " INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('59', '300', 'Lineas de Credito', 'cpdtos_tipo_sistema')";
$sql["20180801"][]	= " INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('60', '500', 'Creditos de Grupo', 'cpdtos_tipo_sistema')";
$sql["20180801"][]	= " INSERT INTO `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tabla_virtual`) VALUES ('61', '900', 'Leasing', 'cpdtos_tipo_sistema')";
$sql["20180801"][]	= "UPDATE `creditos_plan_de_pagos` SET `estatusactivo`=1";
$sql["20180801"][]	= "ALTER TABLE `creditos_plan_de_pagos` CHANGE COLUMN `estatusactivo` `estatusactivo` INT(2) NULL DEFAULT '1' ";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('creditos.plandepagos.refill.frm.php')";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('cuentas.panel.edicion.frm.php')";
$sql["20180801"][]	= "ALTER TABLE `captacion_cuentas` ADD COLUMN `alias` VARCHAR(25) NULL DEFAULT '' AFTER `tasa_gat`";
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('900200', 'MSG_REQUIERE_CHEQUE', 'La Operacion requiere un cheque.')";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('2012', 'Error al cobrar', 'common')";
$sql["20180801"][]	= "UPDATE `tesoreria_tipos_de_pago` SET `activo` = '0' WHERE `tipo_de_pago` = 'documento'";
$sql["20180801"][]	= "UPDATE `tesoreria_tipos_de_pago` SET `activo` = '0' WHERE `tipo_de_pago` = 'documento.egreso'";
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9020', 'MSG_ELIJA_EMPLEADOR', 'Elija un Empleador Activo para Continuar')";
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9021', 'MSG_REQUIERE_EMPLEADOR', 'La Operaciones requiere un Empleador.')"; 
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9022', 'MSG_ELIJA_PRODUCTOCR', 'Elija un Producto de Credito para continuar.')";
$sql["20180801"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('200925', 'CREDITO_FALLA_FVENC', 'La Fecha de vencimiento debe ser superior o tener un Minimo.') ";
$sql["20180801"][]	= "ALTER TABLE `general_reports` ADD COLUMN `hinactivos` VARCHAR(100) NULL DEFAULT '' AFTER `tags`,ADD COLUMN `enmulti` INT(2) NULL DEFAULT '0' AFTER `hinactivos` ";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('menu.edit.frm.php')";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('menu.new.frm.php')";
$sql["20180801"][]	= "UPDATE `general_menu` SET `menu_destination`='' WHERE `menu_destination`='_NULL'";
$sql["20180801"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES (3038, 3030, 'Catalogo de Periocidad', 'frmcreditos/creditos-periodicidad.frm.php', 'Catalogo de Periocidad', 'fa-list-alt', 'command', '3038', '3038', 'true') ";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('creditos-periodicidad.edit.frm.php')";
$sql["20180801"][]	= "ALTER TABLE `creditos_periocidadpagos` CHANGE COLUMN `titulo_en_informe` `titulo_en_informe` VARCHAR(20) NULL DEFAULT 'PAGO FIJO PERIODICO' COMMENT 'PAGO FIJO PERIODICO, ABONO CAP. PERIODICO, AL VENCIMIENTO, REVOLVENTE' ";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('ebalanza.rpt.php')";
$sql["20180801"][]	= "ALTER TABLE `sistema_permisos` ADD COLUMN `estatus` INT(2) NULL DEFAULT '1' AFTER `nombre_objeto`";
$sql["20180801"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('619', 'FORM', 'CREDITOS.NO_CAPITAL_ANTES_INTERES', '', '', '', '', '1') ";
$sql["20180801"][]	= "ALTER TABLE `general_menu` ADD COLUMN `estatus` INT(2) NULL DEFAULT '1' AFTER `menu_showin_toolbar`";
$sql["20180801"][]	= "ALTER TABLE `entidad_configuracion` ADD COLUMN `estatus` INT(2) NULL DEFAULT '1' AFTER `valor_del_parametro`";
$sql["20180801"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('104', 'Persona Importada o Exportada', 'common')";
$sql["20180801"][]	= "UPDATE `sistema_programacion_de_avisos` SET `intent_command` = 'rptcreditos/parcialidades_pendientes.rpt.php?on={fecha_dia_siguiente}&off={fecha_dia_siguiente}&out=default' WHERE `idprograma` = '4'";
$sql["20180801"][]	= "UPDATE `sistema_programacion_de_avisos` SET `intent_command` = 'rptoperaciones/ingresos.acumulado.personas.rpt.php?on={fecha_inicio_de_mes}&off={fecha}&estado=todas&out=default&empresa=todas&tipodepago=transferencia&usuario=todas&tipooperacion=todas&cuentabancaria=todas' WHERE `idprograma` = '9'";
$sql["20180801"][]	= "ALTER TABLE `creditos_lineas` ADD COLUMN `tasa_mora` FLOAT(6,3) NULL DEFAULT '0.000' AFTER `periocidad`,ADD COLUMN `pmismodia` INT(2) NULL DEFAULT '1' COMMENT 'Plan en los mismos dias' AFTER `tasa_mora`";
$sql["20180801"][]	= "UPDATE `general_menu` SET `menu_rules` = '14@rw,99@rw' WHERE `idgeneral_menu` = '11033' OR `idgeneral_menu` = '11034' OR `idgeneral_menu` = '11039' OR `idgeneral_menu` = '11032'";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('aml.alertas.svc.php')";
$sql["20180801"][]	= "INSERT INTO `operaciones_tipos` (`idoperaciones_tipos`, `descripcion_operacion`, `clasificacion`, `subclasificacion`, `cuenta_contable`, `descripcion`, `recibo_que_afecta`, `tipo_operacion`, `visible_reporte`, `class_efectivo`, `mvto_que_afecta`, `afectacion_en_recibo`, `afectacion_en_notificacion`, `producto_aplicable`, `constituye_fondo_automatico`, `integra_vencido`, `afectacion_en_sdpm`, `cargo_directo`, `codigo_de_valoracion`, `periocidad_afectada`, `integra_parcialidad`, `es_estadistico`, `formula_de_calculo`, `formula_de_cancelacion`, `importancia_de_neutralizacion`, `preservar_movimiento`, `tasa_iva`, `nombre_corto`, `estatus`, `precio`) VALUES ('181', 'PAGO GTOS INVESTIGACION', '0', '0', '\$cuenta = \"\";', 'Pago de Investigacion de Credito', '99', '181', '1', '1', '99', '1', '0', '0', '0', '0', '0', '0', '', 'ninguna', '0', '0', '', '', '99', '0', '0.160', 'PAGO INVEST', '1', '30')";
$sql["20180801"][]	= "ALTER TABLE `operaciones_recibos` ADD COLUMN `fecha_valor` DATE NULL AFTER `idusuario_cbza`";
$sql["20180801"][]	= "ALTER TABLE `operaciones_recibos` CHANGE COLUMN `fecha_valor` `fecha_valor` DATE NULL DEFAULT '0000-00-00'";
$sql["20180801"][]	= "ALTER TABLE `operaciones_recibos_arch` ADD COLUMN `fecha_valor` DATE NULL DEFAULT '0000-00-00' AFTER `idusuario_cbza`";
$sql["20180801"][]	= "UPDATE `operaciones_recibos` SET `fecha_valor`=`fecha_operacion`";
$sql["20180801"][]	= "UPDATE `operaciones_recibos_arch` SET `fecha_valor`=`fecha_operacion`";
$sql["20180801"][]	= "SELECT setNuevoPermisoX('recibos-editar.frm.php')";
$sql["20180801"][]	= "UPDATE `general_reports` SET `aplica` = 'seguimiento' WHERE `idreport` = '10009'";
$sql["20180801"][]	= "UPDATE `general_reports` SET `descripcion_reports` = 'Creditos.- Reporte de Parcialidades' WHERE `idreport` = '10009'";
$sql["20180801"][]	= "UPDATE `general_reports` SET `descripcion_reports` = 'Creditos.- Letras/Cuotas Vencidas' WHERE `idreport` = '1004'";
$sql["20180801"][]	= "UPDATE `general_reports` SET `descripcion_reports` = 'Creditos.- Letras/Cuotas Vencidas con Seguimiento' WHERE `idreport` = '1005'";
$sql["20180801"][]	= "ALTER TABLE `seguimiento_notificaciones` ADD COLUMN `periodosvencidos` INT(4) NULL DEFAULT '0' AFTER `nota_entrega`";
$sql["20180801"][]	= "ALTER TABLE `creditos_montos` ADD COLUMN `periodo_pends` INT(5) NULL DEFAULT '0' AFTER `ints_tot_calc`";

$sql["20180801"][]	= "SELECT setNuevoPermisoX('actualizador.php')";

$sql["20181101"][]	= "SELECT setNuevoPermisoX('notificacion.rpt.php')";
$sql["20181101"][]	= "SELECT setNuevoPermisoX('cbza-gen.svc.php')";
$sql["20181101"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('620', 'SYSTEM', 'SEGUIMIENTO.TODOS_PUEDEN', '', '', '', '', '1')";
$sql["20181101"][]	= "UPDATE `creditos_solicitud` SET `tipo_autorizacion`=1 WHERE`fecha_solicitud` <='2018-11-09' AND (SELECT SUM(`creditos`) FROM `tmp_personas_estadisticas` WHERE `tmp_personas_estadisticas`.`persona`=`creditos_solicitud`.`numero_socio`)<=1";
$sql["20181101"][]	= "ALTER TABLE `socios_general` ADD COLUMN `tasapena` FLOAT(6,3) NULL DEFAULT '0' AFTER `idejecutivo`";
$sql["20181101"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('621', 'SYSTEM', 'RECIBOS.NO.ARRASTRA_PENAS', '', '', '', '', '1')";
$sql["20181101"][]	= "UPDATE `general_formulas` SET `estructura_de_la_formula` = '\$DIAS_PENA = \$DIAS_MORA; if (\$DIAS_PENA >  0){ \$moratorio=0;\$penas=\$TOTAL_MONTO_LETRA*\$TASA_PENA; }' WHERE `aplicado_a` = 'php_pena_x_letra'";
$sql["20181101"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9023', 'MSG_ELIJA_RECIBO', 'Capture un Codigo de Recibo.')";
$sql["20181101"][]	= "CREATE TABLE IF NOT EXISTS `personas_seguros` ( `idpersonas_seguros` INT NOT NULL AUTO_INCREMENT,  `persona` BIGINT(25) NOT NULL,  `credito` BIGINT(25) NULL DEFAULT '1',  `tiposeguro` INT(2) NOT NULL DEFAULT '1' COMMENT '1=credto,2=desempleo',  `fecha_vencimiento` DATE NULL,  `tiempo` INT(11) NULL DEFAULT '0',  `monto_cuota` FLOAT(12,2) NULL DEFAULT '0.0',  `monto_seguro` DOUBLE(18,2) NULL DEFAULT '0.00',  `estatus` INT(2) NULL DEFAULT '1',  PRIMARY KEY (`idpersonas_seguros`)) ENGINE = InnoDB";
$sql["20181101"][]	= "SELECT setNuevoPermisoX('lista_de_bks.frm.php')";
$sql["20181101"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES ('11017', '11010', 'Respaldos del La BD', 'frmsecurity/lista_de_bks.frm.php', 'Descargar Respaldos de la BD', 'fa-download', 'command', '11017', '11017', 'true')";
$sql["20181101"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('4', 'Descarga de Archivos o Recurso', 'common')";
$sql["20181101"][]	= "SELECT setNuevoPermisoX('lista-avales.frm.php')";
$sql["20181101"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`) VALUES ('2070', '2000', 'Listas de Personas', '', 'fa-caret-right', 'parent', '2070', '2070')";
$sql["20181101"][]	= "UPDATE `general_menu` SET `menu_title` = 'Avales y Garantias' , `menu_description` = 'Operaciones con Garantias Reales y Avales' WHERE `idgeneral_menu` = '7010' ";
$sql["20181101"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES ('7013', '7010', 'Lista de Avales', 'frmsocios/lista-avales.frm.php', 'Lista de Avales', 'fa-users', 'command', '7013', '7013', 'true')";
$sql["20181101"][]	= "SELECT setNuevoPermisoX('lista-relaciones.frm.php')";
$sql["20181101"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`) VALUES ('2071', '2070', 'Lista de Relaciones', 'frmsocios/lista-relaciones.frm.php', 'fa-users', 'command', '2071', '2071')";
$sql["20181101"][]	= "SELECT setNuevoPermisoX('matriz-de-riesgo.edit.frm.php')";
$sql["20181101"][]	= "SELECT setNuevoPermisoX('perfiles-de-riesgo.new.frm.php')";
$sql["20181101"][]	= "ALTER TABLE `personas_documentacion_tipos` ADD COLUMN `es_cont` INT(2) NULL DEFAULT '0' COMMENT 'Es Tipo de Documentacion' AFTER `es_ident`";
$sql["20181101"][]	= "SELECT setNuevoPermisoX('personas_documentos.add.frm.php')";
$sql["20181101"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('622', 'FORM', 'CREDITOS.LISTA_REQUISITOS', '', '', '', '')";
$sql["20181101"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('623', 'FORM', 'PERSONAS.SE_PUEDEN_ELIMINAR', '', '', '', '')";
$sql["20181101"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('105', 'Documento o Archivo Cargado', 'common')";
$sql["20181101"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('20021', 'Cancelacion del Rechazo', 'common')";
...
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('62','AA','Arrendamiento Automotriz.','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('63','AB','Automotriz Bancario','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('64','AE','Física Actividad Empresarial','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('65','AM','Aparatos/Muebles','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('66','AR','Arrendamiento','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('67','AV','Aviación','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('68','BC','Banca Comunal','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('69','BL','Bote/Lancha','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('70','BR','Bienes Raíces','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('71','CA','Compra De Automóvil','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('72','CC','Crédito Al Consumo','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('73','CF','Crédito Fiscal','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('74','CO','Consolidación','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('75','CP','Crédito Personal Al Consumo','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('76','ED','Editorial','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('77','EQ','Equipo','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('78','FF','Fondeo Fira','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('79','FI','Fianza','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('80','FT','Factoraje','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('81','GS','Grupo Solidario','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('82','OT','Otros','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('83','HB','Hipotecario Bancario','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('84','HE','Préstamo Tipo Home Equity','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('85','HG','Hipotecario de Gobierno','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('86','HV','Hipotecario O Vivienda','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('87','LC','Línea De Crédito','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('88','MC','Mejoras A La Casa','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('89','NG','Préstamo No Garantizado','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('90','PB','Préstamo Personal Bancario','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('91','PC','Procampo','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('92','PE','Préstamo Para Estudiante','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('93','PG','Préstamo Garantizado','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('94','PQ','Préstamo Quirografario','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('95','PM','Préstamo Empresarial','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('96','PN','Préstamo Nómina','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('97','PP','Préstamo Personal','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('98','SH','Segunda Hipoteca','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('99','TC','Tarjeta De Crédito','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('100','TD','Tarjeta Departamental','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('101','TG','Tarjeta Garantizada','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('102','TS','Tarjeta De Servicios','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('103','VR','Vehículo Recreativo','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "insert into `sistema_catalogo` (`idsistema_catalogo`, `clave`, `descripcion`, `tags`, `objeto`, `tabla_virtual`, `clave_superior`) values('104','NC','Desconocido','','0','cat_sic_tipo_pdto','')";
$sql["20181101"][]	= "SELECT setNuevoPermisoX('lista-de-creditos.frm.php')";

$sql["20181201"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES (3017, 3000, 'Cartera de Credito', 'frmcreditos/lista-creditos.frm.php', 'Cartera de Credito', 'fa-list-alt', 'command', '3017', '3017', 'true')";
$sql["20181201"][]	= "SELECT setNuevoPermisoX('personas-ae.edit.frm.php')";
$sql["20181201"][]	= "SELECT setNuevoPermisoX('ae.svc.php')";
$sql["20181201"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('5', 'Cierre Ya ejecutado', 'common')";
$sql["20181201"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('6', 'Cierre Ejecutado', 'common')";
$sql["20181201"][]	= "SELECT setNuevoPermisoX('sucursales.fix.frm.php')";
$sql["20181201"][]	= "SELECT setNuevoPermisoX('RecibosPorUsuarioEliminados')";
$sql["20181201"][]	= "insert into `general_reports` (`idgeneral_reports`, `descripcion_reports`, `aplica`, `idreport`, `explicacion`, `order_index`, `estatus`, `tags`, `hinactivos`, `enmulti`) values('../rptoperaciones/RecibosPorUsuarioEliminados.rpt.php?','Operaciones.- Recibos Eliminados','general_operaciones','8002',NULL,'0','1','','','0')";
$sql["20181201"][]	= "CREATE TABLE IF NOT EXISTS `sistema_bloqueos` (`idsistema_bloqueos` INT NOT NULL AUTO_INCREMENT,`idusuario` INT(8) NULL,`ip` VARCHAR(25) NULL, `tiempo` INT(11) NULL, PRIMARY KEY (`idsistema_bloqueos`)) ENGINE = INNODB";
$sql["20181201"][]	= "ALTER TABLE `sistema_bloqueos` CHANGE COLUMN `idusuario` `idusuario` INT(8) NULL ,CHANGE COLUMN `ip` `ip` VARCHAR(25) NULL DEFAULT '' ,CHANGE COLUMN `tiempo` `tiempo` INT(11) NULL DEFAULT '0' ,ADD COLUMN `estatus` INT(2) NULL DEFAULT '1' AFTER `tiempo`";
$sql["20181201"][]	= "CREATE TABLE IF NOT EXISTS `sistema_apis` (`idsistema_apis` INT NOT NULL AUTO_INCREMENT,  `idusuario` INT(8) NULL DEFAULT '0',  `tiempo` INT(11) NULL DEFAULT '0',  `vigencia` INT(11) NULL DEFAULT '1' COMMENT 'Vigencia en Horas',  `tipo_api` INT(3) NULL DEFAULT '1' COMMENT '1 API KEY 2 RECUPERACION',  `estatus` INT(2) NULL DEFAULT '1',  `uuid` VARCHAR(100) NULL DEFAULT '',  PRIMARY KEY (`idsistema_apis`)) ENGINE = InnoDB";
$sql["20181201"][]	= "ALTER TABLE `t_03f996214fba4a1d05a68b18fece8e71` ADD COLUMN `uuid_mail` VARCHAR(80) NULL DEFAULT '' AFTER `pin_app`";
$sql["20181201"][]	= "UPDATE `t_03f996214fba4a1d05a68b18fece8e71` SET `uuid_mail`=getMailByPersona(`codigo_de_persona`)";
$sql["20181201"][]	= "ALTER TABLE `sistema_apis` CHANGE `vigencia` `vigencia` INT(11) DEFAULT 1 NULL COMMENT 'Vigencia en sesiones'";

$sql["20190101"][]	= "ALTER TABLE `riesgos_consecuencias` ADD COLUMN `rms_eq` FLOAT(6,4) NULL DEFAULT '0' COMMENT 'Equivalencia en RMS' AFTER `multiplo`";
$sql["20190101"][]	= "ALTER TABLE `riesgos_probabilidad` ADD COLUMN `rms_eq` FLOAT(6,4) NULL DEFAULT '0' AFTER `multiplo`";
$sql["20190101"][]	= " UPDATE `riesgos_consecuencias` SET `rms_eq` = '1' WHERE `idriesgos_consecuencias` = '1'";
$sql["20190101"][]	= " UPDATE `riesgos_consecuencias` SET `rms_eq` = '2' WHERE `idriesgos_consecuencias` = '2'";
$sql["20190101"][]	= " UPDATE `riesgos_consecuencias` SET `rms_eq` = '3' WHERE `idriesgos_consecuencias` = '3'";
$sql["20190101"][]	= " UPDATE `riesgos_consecuencias` SET `rms_eq` = '4' WHERE `idriesgos_consecuencias` = '4'";
$sql["20190101"][]	= " UPDATE `riesgos_consecuencias` SET `rms_eq` = '5' WHERE `idriesgos_consecuencias` = '5'";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `rms_eq` = '1' WHERE `idriesgos_probabilidad` = '1'";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `rms_eq` = '2' WHERE `idriesgos_probabilidad` = '2'";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `rms_eq` = '3' WHERE `idriesgos_probabilidad` = '3'";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `rms_eq` = '4' WHERE `idriesgos_probabilidad` = '4'";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `rms_eq` = '5' WHERE `idriesgos_probabilidad` = '5'";
$sql["20190101"][]	= "ALTER TABLE `aml_listanegra_int` ADD COLUMN `nombre_comp` VARCHAR(200) NULL DEFAULT '' COMMENT 'Nombre complementario' AFTER `estatus`";
$sql["20190101"][]	= " INSERT INTO `socios_tipoingreso` (`idsocios_tipoingreso`, `descripcion_tipoingreso`, `descripcion_detallada`, `estado`, `nivel_de_riesgo`) VALUES ('511', 'PERSONA BLOQUEADA', 'Persona Bloqueada', '0', '100')";
$sql["20190101"][]	= " UPDATE `socios_tipoingreso` SET `estado` = '0' WHERE `idsocios_tipoingreso` = '510'";
$sql["20190101"][]	= " UPDATE `socios_tipoingreso` SET `estado` = '0' WHERE `idsocios_tipoingreso` = '501'";
$sql["20190101"][]	= "ALTER TABLE `aml_listanegra_int` ADD COLUMN `id_comp` VARCHAR(20) NULL DEFAULT '' COMMENT 'ID Complementario' AFTER `nombre_comp`";
$sql["20190101"][]	= " INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_rules`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES ('72103', '72000', 'Carga LPB CNVB', 'frmpld/carga-LPB.frm.php', 'Carga de Personas Bloqueadas CNBV', 'fa-database', '99@rw', 'command', '72103', '72103', 'true')";
$sql["20190101"][]	= " UPDATE `general_menu` SET `menu_type` = 'command' WHERE `idgeneral_menu` = '72102' ";
$sql["20190101"][]	= "ALTER TABLE `aml_risk_catalog` ADD COLUMN `impacto_id` INT NULL DEFAULT '1' COMMENT 'clave de impacto' AFTER `fundamento_legal`, ADD COLUMN `probabilidad_id` INT NULL DEFAULT '1' COMMENT 'clave de probabilidad' AFTER `impacto_id`";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `nombre_probabilidad` = 'Casi Certeza' WHERE `idriesgos_probabilidad` = '5'";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `nombre_probabilidad` = 'Raro' WHERE `idriesgos_probabilidad` = '1'";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `nombre_probabilidad` = 'Improbable' WHERE `idriesgos_probabilidad` = '2'";
$sql["20190101"][]	= " UPDATE `riesgos_probabilidad` SET `nombre_probabilidad` = 'Probable' WHERE `idriesgos_probabilidad` = '4'";
$sql["20190101"][]	= "INSERT INTO `general_formulas` (`aplicado_a`, `estructura_de_la_formula`, `description_short`) VALUES ('rms_calculo_riesgo', '\$RIESGO = \$PROBABILIDAD * \$IMPACTO;', 'Formula de Calculo de Riesgo para el RMS')";
$sql["20190101"][]	= "INSERT INTO `general_menu` (`idgeneral_menu`, `menu_parent`, `menu_title`, `menu_file`, `menu_description`, `menu_image`, `menu_type`, `menu_order`, `menu_help_id`, `menu_showin_toolbar`) VALUES ('70054', '7000', 'Vista de la Matriz de Riesgo', 'frmpld/vista-matriz-riesgo.frm.php', 'Vista y Reporte de la Matriz de Riesgo', 'fa-street-view', 'command', '1', '70054', 'true')";
$sql["20190101"][]	= "ALTER TABLE `aml_risk_levels` CHANGE COLUMN `clave_de_control` `clave_de_control` INT(4) NOT NULL ,ADD COLUMN `hcolor` VARCHAR(20) NULL DEFAULT '' AFTER `nombre_del_nivel` ";
$sql["20190101"][]	= " UPDATE `aml_risk_levels` SET `nombre_del_nivel` = 'Muy Bajo' , `hcolor` = '#F8F8F8' WHERE `clave_de_control` = '1'";
$sql["20190101"][]	= " UPDATE `aml_risk_levels` SET `nombre_del_nivel` = 'Bajo' , `hcolor` = '#FFFF00' WHERE `clave_de_control` = '10'";
$sql["20190101"][]	= " UPDATE `aml_risk_levels` SET `nombre_del_nivel` = 'Medio bajo' , `hcolor` = '#FFFF00' WHERE `clave_de_control` = '25'";
$sql["20190101"][]	= " UPDATE `aml_risk_levels` SET `nombre_del_nivel` = 'Medio' , `hcolor` = '#FFA500' WHERE `clave_de_control` = '50'";
$sql["20190101"][]	= " UPDATE `aml_risk_levels` SET `nombre_del_nivel` = 'Medio Alto' , `hcolor` = '#FF4500' WHERE `clave_de_control` = '75'";
$sql["20190101"][]	= " UPDATE `aml_risk_levels` SET `nombre_del_nivel` = 'Alto' , `hcolor` = '#FF0000' WHERE `clave_de_control` = '100'";

$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `valor_ponderado` = '33' , `probabilidad_id` = '3' WHERE `clave_de_control` = '912201'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '5' WHERE `clave_de_control` = '101501'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '5' WHERE `clave_de_control` = '101502'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '2' WHERE `clave_de_control` = '101510'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '4' WHERE `clave_de_control` = '901001'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '3' WHERE `clave_de_control` = '901002'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '5' , `probabilidad_id` = '2' WHERE `clave_de_control` = '101005'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '3' WHERE `clave_de_control` = '912301'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '3' WHERE `clave_de_control` = '912302'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '4' WHERE `clave_de_control` = '910000'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '4' WHERE `clave_de_control` = '101601'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '4' WHERE `clave_de_control` = '912100'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '3' , `probabilidad_id` = '2' WHERE `clave_de_control` = '912101'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '5' WHERE `clave_de_control` = '912102'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '4' WHERE `clave_de_control` = '801005'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '5' WHERE `clave_de_control` = '101101'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '3' WHERE `clave_de_control` = '101102'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '3' , `probabilidad_id` = '2' WHERE `clave_de_control` = '801007'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '4' WHERE `clave_de_control` = '801008'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' WHERE `clave_de_control` = '801009'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '4' WHERE `clave_de_control` = '911101'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '5' WHERE `clave_de_control` = '911502'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '2' WHERE `clave_de_control` = '901501'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '2' WHERE `clave_de_control` = '101004'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '2' WHERE `clave_de_control` = '901010'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '3' WHERE `clave_de_control` = '101100'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '3' WHERE `clave_de_control` = '801006'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '2' WHERE `clave_de_control` = '101111'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '2' WHERE `clave_de_control` = '801006'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '2' , `probabilidad_id` = '4' WHERE `clave_de_control` = '911100'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '4' WHERE `clave_de_control` = '101401'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '4' WHERE `clave_de_control` = '101402'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '3' WHERE `clave_de_control` = '801011'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '4' WHERE `clave_de_control` = '101001'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `probabilidad_id` = '4' WHERE `clave_de_control` = '101002'";
$sql["20190101"][]	= " UPDATE `aml_risk_catalog` SET `impacto_id` = '3' WHERE `clave_de_control` = '101003'"; 
$sql["20190101"][]	= "UPDATE `aml_risk_levels` SET `hcolor` = '#F8F8F8' WHERE `clave_de_control` = '10'";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('daemon.cache.php')";
$sql["20190101"][]	= "UPDATE `general_menu` SET `menu_destination` = 'principal' WHERE `idgeneral_menu` = '20511' ";

$sql["20190101"][]	= "SELECT setNuevoPermisoX('walook-sync.svc.php')";
$sql["20190101"][]	= "CREATE TABLE IF NOT EXISTS `personas_pt_destino` ( `idpersonas_pt_destino` INT NOT NULL AUTO_INCREMENT,  `nombre_pt_destino` VARCHAR(100) NULL,  PRIMARY KEY (`idpersonas_pt_destino`)) ENGINE = InnoDB";
$sql["20190101"][]	= "CREATE TABLE IF NOT EXISTS `personas_pt_origen` ( `idpersonas_pt_origen` INT NOT NULL AUTO_INCREMENT, `nombre_pt_origen` VARCHAR(100) NULL, PRIMARY KEY (`idpersonas_pt_origen`)) ENGINE = InnoDB";
$sql["20190101"][]	= "INSERT INTO `personas_pt_origen` (`idpersonas_pt_origen`, `nombre_pt_origen`) VALUES ('1', 'Ingresos Propios')";
$sql["20190101"][]	= "INSERT INTO `personas_pt_destino` (`idpersonas_pt_destino`, `nombre_pt_destino`) VALUES ('1', 'Pago de Crédito')";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('personas.perfil-transaccional.edit.frm.php')";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('personas.perfil-transaccional.new.frm.php')";
$sql["20190101"][]	= "ALTER TABLE `creditos_solicitud` ADD UNIQUE INDEX `numero_solicitud_UNIQUE` (`numero_solicitud` ASC)";
$sql["20190101"][]	= "ALTER TABLE `operaciones_recibos` ADD COLUMN `f_ext` VARCHAR(15) NULL DEFAULT '' COMMENT 'folio externo' AFTER `fecha_valor` ";
$sql["20190101"][]	= "ALTER TABLE `operaciones_recibos_arch` ADD COLUMN `f_ext` VARCHAR(15) NULL DEFAULT '' COMMENT 'folio externo' AFTER `fecha_valor` ";
$sql["20190101"][]	= "INSERT INTO `general_error_codigos` (`idgeneral_error_codigos`, `description_error`, `type_err`) VALUES ('2013', 'Recibo Editado', 'common')";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('alertas-panel.frm.php')";
$sql["20190101"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('624', 'FORM', 'RECIBOS.CREDITOS.LIQ.SOLOEXIG', '', '', '', '', '1')";
$sql["20190101"][]	= "ALTER TABLE `usuarios_web_notas` CHANGE COLUMN `tipo` `tipo` INT(4) NOT NULL DEFAULT '2' ,ADD INDEX `fk_usuarios_web_notas_1_idx` (`tipo` ASC)";
$sql["20190101"][]	= "ALTER TABLE `usuarios_web_notas` ADD CONSTRAINT `fk_usuarios_web_notas_1`  FOREIGN KEY (`tipo`)  REFERENCES `socios_memotipos` (`tipo_memo`)  ON DELETE NO ACTION  ON UPDATE NO ACTION";
$sql["20190101"][]	= "ALTER TABLE `usuarios_web_notas` CHANGE `relevancia` `relevancia` INT(4) DEFAULT 1 NOT NULL COMMENT 'Nivel de Riesgo'";
$sql["20190101"][]	= "ALTER TABLE `usuarios_web_notas` ADD INDEX `fk_usuarios_web_notas_2_idx` (`relevancia` ASC)";
$sql["20190101"][]	= "ALTER TABLE `usuarios_web_notas` ADD CONSTRAINT `fk_usuarios_web_notas_2`  FOREIGN KEY (`relevancia`) REFERENCES `entidad_niveles_de_riesgo` (`clave_de_nivel`)  ON DELETE NO ACTION ON UPDATE NO ACTION ";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('usuarios-notas.edit.frm.php')";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('usuarios-notas.new.frm.php')";
$sql["20190101"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9024', 'MSG_CONFIRM_SEND_MSG', '¿ Confirma en envio de este Mensaje ?')";
$sql["20190101"][]	= "UPDATE `general_contratos` SET `texto_del_contrato` = '<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"body\"><tr><td>&nbsp;</td><td class=\"container\"><div class=\"content\"><!-- START CENTERED WHITE CONTAINER --><span class=\"preheader\">var_pre_mail</span><table class=\"main\"><!-- START MAIN CONTENT AREA --><tr><td class=\"wrapper\"><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td><p>Estimado(a): var_dirijido_a,</p><div>var_parrafo_inicio</div><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"btn btn-primary\"><tbody><tr><td align=\"left\"><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tbody><tr><td> <a href=\"var_url_action\" target=\"_blank\">var_title_url_action</a> </td></tr></tbody></table></td></tr></tbody></table><p>var_parrafo_fin</p><p>var_parrafo_despedida</p></td></tr></table></td></tr><!-- END MAIN CONTENT AREA --></table><!-- START FOOTER --><div class=\"footer\"><table border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td class=\"content-block\"><span class=\"apple-link\">variable_nombre_de_la_entidad</span><a href=\"\"></a></td></tr><tr><td class=\"content-block powered-by\"><a href=\"https://www.sipakal.com\">SAFE-OSMS</a>.</td></tr></table></div><!-- END FOOTER --><!-- END CENTERED WHITE CONTAINER --></div></td><td>&nbsp;</td></tr></table>' WHERE `idgeneral_contratos` = '901'";
$sql["20190101"][]	= "ALTER TABLE `aml_alerts` CHANGE COLUMN `tipo_de_aviso` `tipo_de_aviso` INT(8) NULL DEFAULT '1' ,CHANGE COLUMN `estado_en_sistema` `estado_en_sistema` INT(2) NULL DEFAULT '1' COMMENT '0 inactivo 1 activo' ,CHANGE COLUMN `riesgo_calificado` `riesgo_calificado` INT(4) NULL DEFAULT '0' COMMENT 'Nivel de riesgo en entero' , ADD COLUMN `es_fs` INT(2) NULL DEFAULT '0' COMMENT 'Es Falso Positivo' AFTER `envio_rms`";
$sql["20190101"][]	= "ALTER TABLE `aml_alerts` ADD INDEX `fk_aml_alerts_1_idx` (`tipo_de_aviso` ASC)";
$sql["20190101"][]	= "ALTER TABLE `aml_alerts` ADD CONSTRAINT `fk_aml_alerts_1` FOREIGN KEY (`tipo_de_aviso`) REFERENCES `aml_risk_catalog` (`clave_de_control`) ON DELETE NO ACTION ON UPDATE NO ACTION;";
$sql["20190101"][]	= "UPDATE `general_menu` SET `menu_rules` = '2@rw,3@rw,4@rw,5@rw,6@rw,7@rw,8@rw,9@rw,10@rw,11@rw,12@rw,13@rw,14@rw,15@rw,31@rw,41@rw,71@rw,72@rw,73@rw,81@rw,99@rw' WHERE `menu_file` LIKE  '%panel%'";
$sql["20190101"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('625', 'FORM', 'SISTEMA.USAR_APP', '', '', '', '')";
$sql["20190101"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`) VALUES ('626', 'SYSTEM', 'SISTEMA.USAR_AML_SYNC', '', '', '', '')";
$sql["20190101"][]	= "ALTER TABLE `aml_alerts` ADD COLUMN `es_fs` INT(2) NULL DEFAULT '0' COMMENT 'Es Falso Positivo' AFTER `envio_rms`";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('visor-consulta.frm.php')";
$sql["20190101"][]	= "INSERT INTO  `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('2012', 'MSG_CONCEPTO_NOEXIS', 'El concepto no existe!')";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('catalogo-documentacion.edit.frm.php')";
$sql["20190101"][]	= "SELECT setNuevoPermisoX('RecibosPorUsuarioEliminados.rpt.php')";
...
$sql["20190301"][]	= "ALTER TABLE `creditos_productos_costos` CHANGE `clave_de_producto` `clave_de_producto` INT(4) UNSIGNED NULL";
$sql["20190301"][]	= "DELETE FROM `creditos_productos_costos` WHERE (SELECT COUNT(*) FROM `creditos_tipoconvenio` WHERE `idcreditos_tipoconvenio`=`creditos_productos_costos`.`clave_de_producto`) IS NULL OR (SELECT COUNT(*) FROM `creditos_tipoconvenio` WHERE `creditos_tipoconvenio`.`idcreditos_tipoconvenio`=`creditos_productos_costos`.`clave_de_producto`)<=0";
$sql["20190301"][]	= "ALTER TABLE `creditos_productos_costos` ADD INDEX `fk_cred_prod_costo_cred_prod_idx` (`clave_de_producto` ASC)";
$sql["20190301"][]	= "ALTER TABLE `creditos_productos_costos` ADD CONSTRAINT `fk_cred_prod_costo_cred_prod`  FOREIGN KEY (`clave_de_producto`)  REFERENCES `creditos_tipoconvenio` (`idcreditos_tipoconvenio`)  ON DELETE NO ACTION  ON UPDATE NO ACTION";

$sql["20190302"][]	= "CREATE TABLE IF NOT EXISTS `creditos_prods_formatos` (`idcreditos_prods_contratos` INT NOT NULL AUTO_INCREMENT, `producto_credito_id` INT(8) UNSIGNED NULL, `formato_id` INT(8) UNSIGNED NULL,`estatus` INT(2) NOT NULL DEFAULT '1', `etapa_id` INT(4) NULL, `opcional` INT(2) NOT NULL DEFAULT '0', PRIMARY KEY (`idcreditos_prods_contratos`)) ENGINE = InnoDB";
$sql["20190302"][]	= "CREATE TABLE IF NOT EXISTS `creditos_prods_doctos` (`idcreditos_prods_doctos` INT NOT NULL AUTO_INCREMENT,`producto_credito_id` INT(8) UNSIGNED NULL,`documento_id` INT(8) UNSIGNED NULL,`estatus` INT(2) NOT NULL DEFAULT '1',`etapa_id` INT(4) NULL,`opcional` INT(2) NOT NULL DEFAULT '0', PRIMARY KEY (`idcreditos_prods_doctos`)) ENGINE = InnoDB";
$sql["20190302"][]	= "ALTER TABLE `personas_documentacion_tipos` ADD COLUMN `es_mult` INT(2) NULL DEFAULT '0' AFTER `es_cont`";
$sql["20190302"][]	= "SELECT setNuevoPermisoX('creditos-productos-doctos.new.frm.php')";
$sql["20190302"][]	= "SELECT setNuevoPermisoX('creditos-productos-doctos.edit.frm.php')";
$sql["20190302"][]	= "SELECT setNuevoPermisoX('creditos-productos-formatos.new.frm.php')";
$sql["20190302"][]	= "SELECT setNuevoPermisoX('creditos-productos-formatos.edit.frm.php')";
$sql["20190302"][]	= "insert into `operaciones_tipos` (`idoperaciones_tipos`, `descripcion_operacion`, `clasificacion`, `subclasificacion`, `cuenta_contable`, `descripcion`, `recibo_que_afecta`, `tipo_operacion`, `visible_reporte`, `class_efectivo`, `mvto_que_afecta`, `afectacion_en_recibo`, `afectacion_en_notificacion`, `producto_aplicable`, `constituye_fondo_automatico`, `integra_vencido`, `afectacion_en_sdpm`, `cargo_directo`, `codigo_de_valoracion`, `periocidad_afectada`, `integra_parcialidad`, `es_estadistico`, `formula_de_calculo`, `formula_de_cancelacion`, `importancia_de_neutralizacion`, `preservar_movimiento`, `tasa_iva`, `nombre_corto`, `estatus`, `precio`) values('158','PAGO COMISION X ADMON','0','0','\$cuenta  = CUENTA_DE_CUADRE;','PAGO COMISION X ADMON','99','158','1','1','99','1','0','0','0','0','0','0','','ninguna','0','0','','','0','0','0.160','PAGO COM. ADMON','1','0.00')";
$sql["20190302"][]	= "ALTER TABLE `creditos_prods_formatos` ADD CONSTRAINT `fk_cred_prod_eta_cred_etapas` FOREIGN KEY (`etapa_id`) REFERENCES `creditos_etapas`(`idcreditos_etapas`),bADD CONSTRAINT `fk_cred_prod_fmt_gral_fmt` FOREIGN KEY (`formato_id`) REFERENCES `general_contratos`(`idgeneral_contratos`),bADD CONSTRAINT `fk_cred_prod_id_prod_id` FOREIGN KEY (`producto_credito_id`) REFERENCES `creditos_tipoconvenio`(`idcreditos_tipoconvenio`)";

$sql["20190303"][]	= "SELECT setNuevoPermisoX('creditos.productos.copiar-props.frm.php')";
$sql["20190303"][]	= "SELECT setNuevoPermisoX('contratos-editor.upd.frm.php')";
$sql["20190303"][]	= "ALTER TABLE `creditos_plan_de_pagos` ADD COLUMN `pag_cap` DOUBLE(14,2) NULL DEFAULT '0.00' AFTER `estatusactivo`,ADD COLUMN `pag_nums` INT(4) NULL DEFAULT '0' AFTER `pag_cap`,ADD COLUMN `pag_fecha` DATE NULL DEFAULT '0000-00-00' AFTER `pag_nums`";
$sql["20190303"][]	= "UPDATE `creditos_plan_de_pagos` a SET a.`pag_fecha`=a.`fecha_de_pago` WHERE ISNULL(a.`pag_fecha`) OR a.`pag_fecha`='0000-00-00'";
$sql["20190303"][]	= "CREATE TABLE IF NOT EXISTS `orden_desembolso` (`idorden_desembolso` INT NOT NULL AUTO_INCREMENT,  `monto_solicitado` DOUBLE(18,2) NULL DEFAULT '0.00',  `monto_desembolsado` DOUBLE(18,2) NULL DEFAULT '0.00',  `credito` BIGINT(20) NOT NULL,  `tiempo` INT(10) NOT NULL,  `fecha_desembolso` DATE NULL,  `idusuario` INT(8) NULL,  `estado_desembolso` INT(3) NULL DEFAULT '1' COMMENT '1 Solicitado 2 Autorizado 3 Fondeado 4',  `observaciones` VARCHAR(100) NULL,  `idusuario_autoriza` INT(8) NULL DEFAULT '0',  `tiempo_autoriza` INT(10) NULL DEFAULT '0',  `estatus` INT(2) NOT NULL DEFAULT '1',  PRIMARY KEY (`idorden_desembolso`),  INDEX `creds` (`idorden_desembolso` ASC, `credito` ASC)) ENGINE = InnoDB";

$sql["20190305"][]	= "SELECT setNuevoPermisoX('ordenpago.svc.php')";
$sql["20190305"][]	= "SELECT setNuevoPermisoX('conekta.svc.php')";
$sql["20190305"][]	= "CREATE TABLE IF NOT EXISTS `personas_orden_electro` ( `idpersonas_orden_electro` INT NOT NULL AUTO_INCREMENT,  `persona` BIGINT(25) NOT NULL DEFAULT '0',  `contrato` BIGINT(25) NOT NULL DEFAULT '0',  `periodo` INT(6) NOT NULL DEFAULT '0',  `proveedor` VARCHAR(20) NULL DEFAULT '',  `canal` VARCHAR(20) NULL COMMENT 'oxxo_pay',  `usuarioid` INT(6) NULL,  `vencimiento` DATE NULL,  `tiempo` INT(11) NULL,  `monto` DOUBLE(16,2) NULL DEFAULT '0.00',  `referencia` VARCHAR(25) NULL,  `tiempo_pago` INT(11) NULL DEFAULT '0',  `referencia_pago` VARCHAR(25) NULL,  PRIMARY KEY (`idpersonas_orden_electro`)) ENGINE = InnoDB";

$sql["20190305"][]	= "DROP TABLE IF EXISTS `wwwsqldesigner`";
$sql["20190305"][]	= "UPDATE `general_reports` SET `hinactivos` = 'idtipoderecibo,idtipo_de_operacion,idcajero,idestado' WHERE `aplica` = 'general_creditos'";
$sql["20190305"][]	= "UPDATE `general_reports` SET `hinactivos` = '' WHERE `idreport` = '10006'";
$sql["20190305"][]	= "UPDATE `general_reports` SET `hinactivos` = '' WHERE `idreport` = '174'";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud` CHANGE `tipo_convenio` `tipo_convenio` INT(6) UNSIGNED DEFAULT 99 NOT NULL, CHANGE `grupo_asociado` `grupo_asociado` BIGINT(20) UNSIGNED DEFAULT 999 NOT NULL, CHANGE `tipo_de_calculo_de_interes` `tipo_de_calculo_de_interes` INT(2) UNSIGNED DEFAULT 2 NOT NULL, CHANGE `tipo_de_origen` `tipo_de_origen` INT(5) UNSIGNED DEFAULT 1 NOT NULL, CHANGE `tipo_de_dias_de_pago` `tipo_de_dias_de_pago` INT(3) UNSIGNED DEFAULT 1 NOT NULL, CHANGE `tipo_de_lugar_de_pago` `tipo_de_lugar_de_pago` INT(4) UNSIGNED DEFAULT 1 NOT NULL, CHANGE `tipo_de_dispersion` `tipo_de_dispersion` INT(4) UNSIGNED DEFAULT 1 NOT NULL";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud` ADD CONSTRAINT `fk_credito_cred_tipo_conv` FOREIGN KEY (`tipo_convenio`) REFERENCES `grupopadio`.`creditos_tipoconvenio`(`idcreditos_tipoconvenio`)";
$sql["20190305"][]	= "INSERT INTO `general_contratos` (`idgeneral_contratos`, `tipo_contrato`, `estatus`, `titulo_del_contrato`, `texto_del_contrato`, `tags`, `ruta`) VALUES ('8014', '200', 'alta', 'Ficha Representante 1', '<!-- Contenido -->', '', '')";
$sql["20190305"][]	= "UPDATE `general_reports` SET `hinactivos` = 'idtipoderecibo,idtipo_de_operacion,idcajero,idestado,idfecha-0' WHERE `idreport` = '10002'";
$sql["20190305"][]	= "INSERT INTO `general_reports` (`idgeneral_reports`, `descripcion_reports`, `aplica`, `idreport`, `explicacion`, `order_index`, `estatus`, `tags`, `hinactivos`, `enmulti`) VALUES ('../rptcreditos/reporte-vintage-echale.rpt.php?', 'Creditos.- Reporte Vintage ECH', 'general_creditos', '10011', 'Reporte Vintage', '10', '1', '', 'idtipoderecibo,idtipo_de_operacion,idcajero,idestado', '0')";
$sql["20190305"][]	= "SELECT setNuevoPermisoX('reporte-vintage-echale.rpt.php')";
$sql["20190305"][]	= "CALL setPurgeTablaMontos()";
$sql["20190305"][]	= "ALTER TABLE `creditos_montos` DROP INDEX `bycred`, ADD  UNIQUE INDEX `bycred` (`clave_de_credito`)";
$sql["20190305"][]	= "UPDATE `creditos_solicitud` INNER JOIN (SELECT `operaciones_mvtos`.`docto_afectado` AS `credito`, MIN(IF(`operaciones_mvtos`.`tipo_operacion`  = 410 AND `operaciones_mvtos`.`afectacion_real` >0,`operaciones_mvtos`.`periodo_socio`,`creditos_solicitud`.`pagos_autorizados`)) AS 'letra_capital',MIN(IF(`operaciones_mvtos`.`tipo_operacion`  = 411 AND `operaciones_mvtos`.`afectacion_real` >0,`operaciones_mvtos`.`periodo_socio`,`creditos_solicitud`.`pagos_autorizados`)) AS 'letra_interes'FROM `operaciones_mvtos` INNER JOIN `creditos_solicitud` ON `creditos_solicitud`.`numero_solicitud` = `operaciones_mvtos`.`docto_afectado` GROUP BY `operaciones_mvtos`.`docto_afectado`) tt ON tt.`credito` = `creditos_solicitud`.`numero_solicitud` SET `ultimo_periodo_afectado` = tt.`letra_interes` WHERE `creditos_solicitud`.`ultimo_periodo_afectado`>`creditos_solicitud`.`pagos_autorizados`";

$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_soc` FOREIGN KEY (`numero_socio`) REFERENCES `socios_general`(`codigo`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_periodicidad` FOREIGN KEY (`periocidad_de_pago`) REFERENCES `creditos_periocidadpagos`(`idcreditos_periocidadpagos`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_mods` FOREIGN KEY (`tipo_credito`) REFERENCES `creditos_modalidades`(`idcreditos_modalidades`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_estatus` FOREIGN KEY (`estatus_actual`) REFERENCES `creditos_estatus`(`idcreditos_estatus`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_tauth` FOREIGN KEY (`tipo_autorizacion`) REFERENCES `creditos_tipo_de_autorizacion`(`idcreditos_tipo_de_autorizacion`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_ofcred` FOREIGN KEY (`oficial_credito`) REFERENCES `t_03f996214fba4a1d05a68b18fece8e71`(`idusuarios`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_periocreds` FOREIGN KEY (`periodo_solicitudes`) REFERENCES `creditos_periodos`(`idcreditos_periodos`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_destinos` FOREIGN KEY (`destino_credito`) REFERENCES `creditos_destinos`(`idcreditos_destinos`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_idusers` FOREIGN KEY (`idusuario`) REFERENCES `t_03f996214fba4a1d05a68b18fece8e71`(`idusuarios`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_nriesgo` FOREIGN KEY (`nivel_riesgo`) REFERENCES `creditos_nivelesriesgo`(`idcreditos_nivelesriesgo`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_prod` FOREIGN KEY (`tipo_convenio`) REFERENCES `creditos_tipoconvenio`(`idcreditos_tipoconvenio`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_prod` FOREIGN KEY (`grupo_asociado`) REFERENCES `socios_grupossolidarios`(`idsocios_grupossolidarios`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_ofseg` FOREIGN KEY (`oficial_seguimiento`) REFERENCES `t_03f996214fba4a1d05a68b18fece8e71`(`idusuarios`)";
$sql["20190305"][]	= "ALTER TABLE `creditos_solicitud`  ADD CONSTRAINT `pk_cred_suc` FOREIGN KEY (`sucursal`) REFERENCES `general_sucursales`(`codigo_sucursal`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_genero` FOREIGN KEY (`genero`) REFERENCES `socios_genero`(`idsocios_genero`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_estatus` FOREIGN KEY (`estatusactual`) REFERENCES `socios_estatus`(`tipo_estatus`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_region` FOREIGN KEY (`region`) REFERENCES `socios_region`(`idsocios_region`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_cl` FOREIGN KEY (`cajalocal`) REFERENCES `socios_cajalocal`(`idsocios_cajalocal`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_tipoing` FOREIGN KEY (`tipoingreso`) REFERENCES `socios_tipoingreso`(`idsocios_tipoingreso`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_ecivil` FOREIGN KEY (`estadocivil`) REFERENCES `socios_estadocivil`(`idsocios_estadocivil`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_iduser` FOREIGN KEY (`idusuario`) REFERENCES `t_03f996214fba4a1d05a68b18fece8e71`(`idusuarios`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_gsolidario` FOREIGN KEY (`grupo_solidario`) REFERENCES `socios_grupossolidarios`(`idsocios_grupossolidarios`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_juridica` FOREIGN KEY (`personalidad_juridica`) REFERENCES `socios_figura_juridica`(`idsocios_figura_juridica`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_empresa` FOREIGN KEY (`dependencia`) REFERENCES `socios_aeconomica_dependencias`(`idsocios_aeconomica_dependencias`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_sucursal` FOREIGN KEY (`sucursal`) REFERENCES `general_sucursales`(`codigo_sucursal`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_tipodoc` FOREIGN KEY (`tipo_de_identificacion`) REFERENCES `personas_documentacion_tipos`(`clave_de_control`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_paises` FOREIGN KEY (`pais_de_origen`) REFERENCES `personas_domicilios_paises`(`clave_de_control`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_nriesgo` FOREIGN KEY (`nivel_de_riesgo_aml`) REFERENCES `aml_risk_levels`(`clave_de_control`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_rfiscal` FOREIGN KEY (`regimen_fiscal`) REFERENCES `personas_regimen_fiscal`(`clave_de_regimen`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_classx` FOREIGN KEY (`xclasificacion`) REFERENCES `personas_xclasificacion`(`idpersonas_xclasificacion`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_classy` FOREIGN KEY (`yclasificacion`) REFERENCES `personas_yclasificacion`(`idpersonas_yclasificacion`)";
$sql["20190305"][]	= "ALTER TABLE `socios_general` ADD CONSTRAINT `fk_personas_classz` FOREIGN KEY (`zclasificacion`) REFERENCES `personas_zclasificacion`(`idpersonas_zclasificacion`)";
$sql["20190305"][]	= "ALTER TABLE `personas_datos_extranjero`    ADD CONSTRAINT `pk_de_persona` FOREIGN KEY (`clave_de_persona`) REFERENCES `socios_general`(`codigo`)";
$sql["20190305"][]	= "ALTER TABLE `personas_datos_extranjero`    ADD CONSTRAINT `pk_de_pais` FOREIGN KEY (`pais_de_nacionalidad`) REFERENCES `personas_domicilios_paises`(`clave_de_control`)";
$sql["20190305"][]	= "ALTER TABLE `personas_perfil_transaccional`  ADD CONSTRAINT `pk_pf_persona` FOREIGN KEY (`clave_de_persona`) REFERENCES `socios_general`(`codigo`)";
$sql["20190305"][]	= "ALTER TABLE `personas_perfil_transaccional`  ADD CONSTRAINT `pk_pf_tipo` FOREIGN KEY (`clave_de_tipo_de_perfil`) REFERENCES `personas_perfil_transaccional_tipos`(`idpersonas_perfil_transaccional_tipos`)";
$sql["20190305"][]	= "ALTER TABLE `personas_perfil_transaccional`  ADD CONSTRAINT `pk_pf_pais` FOREIGN KEY (`pais_de_origen`) REFERENCES `personas_domicilios_paises`(`clave_de_control`)";
$sql["20190305"][]	= "ALTER TABLE `personas_aseguradoras`  ADD CONSTRAINT `pk_aseg_persona` FOREIGN KEY (`persona`) REFERENCES `socios_general`(`codigo`)";
$sql["20190305"][]	= "ALTER TABLE `personas_checklist`  ADD CONSTRAINT `pk_chk_persona` FOREIGN KEY (`clave_de_persona`) REFERENCES `socios_general`(`codigo`)";
$sql["20190305"][]	= "UPDATE `entidad_configuracion` SET `valor_del_parametro` = 'https://messages.opensourcemicrofinance.org' WHERE `nombre_del_parametro` = 'push_servidor_de_aplicacion'";
$sql["20190305"][]	= "UPDATE `entidad_configuracion` SET `valor_del_parametro` = 'ApnBfQBC5oN3ed3' WHERE `nombre_del_parametro` = 'push_token_de_aplicacion'";

$sql["20190305"][]	= "ALTER TABLE `creditos_montos` ADD COLUMN `num_meses` INT(6) NULL DEFAULT 0 AFTER `cbanc_2`";

$sql["20190701"][]	= "UPDATE `leasing_usuarios` SET originador=1 WHERE originador <=1";
$sql["20190701"][]	= "ALTER TABLE `leasing_usuarios` CHANGE COLUMN `originador` `originador` INT(8) NOT NULL DEFAULT '0'";
$sql["20190701"][]	= "ALTER TABLE `t_03f996214fba4a1d05a68b18fece8e71` CHANGE COLUMN `f_28fb96d57b21090705cfdf8bc3445d2a` `f_28fb96d57b21090705cfdf8bc3445d2a` VARCHAR(100) NOT NULL , CHANGE COLUMN `f_34023acbff254d34664f94c3e08d836e` `f_34023acbff254d34664f94c3e08d836e` VARCHAR(100) NOT NULL DEFAULT ''";
$sql["20190701"][]	= "ALTER TABLE `t_03f996214fba4a1d05a68b18fece8e71` ADD UNIQUE INDEX `uninom` (`f_28fb96d57b21090705cfdf8bc3445d2a` ASC)";
$sql["20190701"][]	= "ALTER TABLE `t_03f996214fba4a1d05a68b18fece8e71` ADD `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP";
$sql["20190701"][]	= "ALTER TABLE `leasing_usuarios` ADD UNIQUE INDEX `fk_uni_email` (`correo_electronico` ASC)";
$sql["20190701"][]	= "UPDATE `entidad_configuracion` SET `valor_del_parametro` = 'https://messages.opensourcemicrofinance.org:8443' WHERE `nombre_del_parametro` = 'push_servidor_de_aplicacion'";
$sql["20190701"][]	= "ALTER TABLE `aml_personas_descartadas` CHANGE COLUMN `clave_de_oficial` `clave_de_oficial` INT(6) UNSIGNED NULL DEFAULT '0'";
$sql["20190701"][]	= "ALTER TABLE `aml_personas_descartadas` ADD INDEX `fk_aml_pd_users_idx` (`clave_de_oficial` ASC)";
$sql["20190701"][]	= "ALTER TABLE `aml_personas_descartadas` ADD CONSTRAINT `fk_aml_pd_users` FOREIGN KEY (`clave_de_oficial`) REFERENCES `t_03f996214fba4a1d05a68b18fece8e71` (`idusuarios`) ON DELETE NO ACTION ON UPDATE NO ACTION";
$sql["20190701"][]	= "ALTER TABLE `operaciones_mvtos` ADD CONSTRAINT `fk_ops_tipos_ops_1` FOREIGN KEY (`tipo_operacion`) REFERENCES `operaciones_tipos` (`idoperaciones_tipos`) ON DELETE NO ACTION ON UPDATE NO ACTION";
$sql["20190701"][]	= "ALTER TABLE `socios_vivienda` ADD CONSTRAINT `fk_sv_1_persona` FOREIGN KEY (`socio_numero`) REFERENCES `socios_general` (`codigo`) ON DELETE NO ACTION ON UPDATE NO ACTION";
$sql["20190701"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('629', 'FORM', 'CREDITOS.REEST_BLOQ_CAPITAL', '', '', '', '', '1')";
$sql["20190701"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('630', 'FORM', 'CREDITOS.REEST_REQ_INTERES', '', '', '', '', '1')";
$sql["20190701"][]	= "SELECT setNuevoPermisoX('intereses.fix.frm.php')";
$sql["20190701"][]	= "ALTER TABLE `creditos_datos_originacion` ADD COLUMN `estatus` INT(2) NULL DEFAULT '1' AFTER `monto_vinculado`";
$sql["20190701"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('631', 'FORM', 'CREDITOS.ARRENDAMIENTO.NO_BONOS', '', '', '', '', '1')";
$sql["20190701"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('632', 'FORM', 'PERSONAS.RIESGO_EN_PANEL', '', '', '', '', '0')";
$sql["20190701"][]	= "INSERT INTO `leasing_escenarios` (`idleasing_escenarios`, `plazo`, `descripcion_escenario`) VALUES ('5', '18', '18 Mensualidades')";

$sql["20190701"][]	= "ALTER TABLE `creditos_etapas` ADD COLUMN `orden_general` INT(2) NULL DEFAULT '0' AFTER `tags`,ADD COLUMN `etapa_sistema` VARCHAR(30) NULL DEFAULT '' AFTER `orden_general`";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'solicitud' WHERE `idcreditos_etapas` = '99'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'solicitud' WHERE `idcreditos_etapas` = '100'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'solicitud' WHERE `idcreditos_etapas` = '103'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'originacion' WHERE `idcreditos_etapas` = '1'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'originacion' WHERE `idcreditos_etapas` = '101'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'originacion' WHERE `idcreditos_etapas` = '102'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'administracion' WHERE `idcreditos_etapas` = '10'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'administracion' WHERE `idcreditos_etapas` = '20'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'administracion' WHERE `idcreditos_etapas` = '30'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'administracion' WHERE `idcreditos_etapas` = '50'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'autorizacion' WHERE `idcreditos_etapas` = '98'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'autorizacion' WHERE `idcreditos_etapas` = '501'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'autorizacion' WHERE `idcreditos_etapas` = '987'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'autorizacion' WHERE `idcreditos_etapas` = '988'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'autorizacion' WHERE `idcreditos_etapas` = '989'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'autorizacion' WHERE `idcreditos_etapas` = '991'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `etapa_sistema` = 'desembolso' WHERE `idcreditos_etapas` = '501'"; 
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '1' WHERE `idcreditos_etapas` = '1'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '2' WHERE `idcreditos_etapas` = '101'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '3' WHERE `idcreditos_etapas` = '102'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '1' WHERE `idcreditos_etapas` = '501'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '1' WHERE `idcreditos_etapas` = '991'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '2' WHERE `idcreditos_etapas` = '98'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '3' WHERE `idcreditos_etapas` = '987'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '4' WHERE `idcreditos_etapas` = '989'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '5' WHERE `idcreditos_etapas` = '988'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '1' WHERE `idcreditos_etapas` = '10'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '2' WHERE `idcreditos_etapas` = '30'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '3' WHERE `idcreditos_etapas` = '20'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '4' WHERE `idcreditos_etapas` = '50'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '2' , `etapa_sistema` = 'originacion' WHERE `idcreditos_etapas` = '100'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '1' WHERE `idcreditos_etapas` = '99'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '2' WHERE `idcreditos_etapas` = '103'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '3' WHERE `idcreditos_etapas` = '101'";
$sql["20190701"][]	= "UPDATE `creditos_etapas` SET `orden_general` = '4' WHERE `idcreditos_etapas` = '102'"; 

$sql["20190701"][]	= "SELECT setNuevoPermisoX('cartera.creditos-vencidos.frm.php')";
$sql["20190701"][]	= "SELECT setNuevoPermisoX('cartera.pagos-del-dia.frm.php')";
$sql["20190701"][]	= "SELECT setNuevoPermisoX('reporte-vintage-echale.rpt.php')";
$sql["20190701"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9025', 'MSG_AML_CONOCE_PERS', '¿ Conoce al Cliente Involucrado ?')";
$sql["20190701"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9026', 'MSG_AML_CONOCE_USER', '¿ Conoce al Empleado Involucrado ?')";
$sql["20190701"][]	= "INSERT INTO `sistema_mensajes` (`idsistema_mensajes`, `topico`, `mensaje`) VALUES ('9027', 'MSG_AML_CONOCE_DOCTO', '¿Tiene algún documento recibo relacionado ?')";
$sql["20190701"][]	= "SELECT setNuevoPermisoX('core.reportes.inc.php')";
$sql["20190701"][]	= "INSERT INTO `entidad_reglas` (`identidad_reglas`, `contexto`, `nombre`, `evento`, `sujetos`, `reglas`, `metadata`, `valor`) VALUES ('631', 'FORM', 'CREDITOS.NO.CALCULA_INTS_CORRIENTE', '', '', '', '', '1')";
$sql["20190701"][]	= "SELECT setNuevoPermisoX('reporte-vintage.rpt.php')";
//$sql["20190701"][]	= "";
//$sql["20190701"][]	= "";
//$sql["20190701"][]	= "";
//$sql["20190701"][]	= "";
...
//$sql["20190701"][]	= "SELECT setNuevoPermisoX('')";
//$sql["20190701"][]	= "SELECT setNuevoPermisoX('')";
//$sql["20190701"][]	= "SELECT setNuevoPermisoX('')";
//$sql["20190701"][]	= "SELECT setNuevoPermisoX('')";
//$sql["20190701"][]	= "SELECT setNuevoPermisoX('')";

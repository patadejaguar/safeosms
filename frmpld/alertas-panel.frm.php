...
if($xAlert->init() == true){
	...
	$xFRM->OButton("TR.PANEL DE PERSONA", "var xP=new PersGen();xP.goToPanel(" . $xAlert->getPersonaDeOrigen() . ")", $xFRM->ic()->PERSONA);
	
	$xFRM->OButton("TR.MODIFICAR ESTATUS", "jsModificarEstatus($clave)", $xFRM->ic()->EJECUTAR);

...
$ByFechas		= $xFil->CompromisosPorFechas($FechaInicial, $FechaFinal);
$ByOficial		= $xFil->OficialPorClave($oficial);
$sql			= " SELECT
	...
	`seguimiento_compromisos`.`socio_comprometido` AS `persona`,
	`socios`.`nombre`,
	...
	getTrad(`seguimiento_compromisos`.`tipo_compromiso`) AS `tipo`,
	`seguimiento_compromisos`.`anotacion`,
	getTrad(`seguimiento_compromisos`.`estatus_compromiso`) AS `estatus`

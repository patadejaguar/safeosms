...
//=====================================================================================================
$xHP		= new cHPage("TR.PERSONAS POR CAJA_LOCAL", HP_REPORT);
$xL			= new cSQLListas();
$xF			= new cFecha();
$query		= new MQL();
...
$cajalocal		= parametro("cajalocal", $clave, MQL_INT); $caja	= parametro("f3", $cajalocal,MQL_INT);
//===========  General
...
$sql			= "SELECT
	...
	COUNT(`socios_general`.`codigo`)				AS `numero_de_personas` ,

...
//=====================================================================================================
$xHP		= new cHPage("TR.GARANTIAS ENTREGADAS", HP_REPORT);
$xL			= new cSQLListas();
$xF			= new cFecha();
$xQL		= new MQL();
...
$ByFechas		= $xFil->CredsGarantiasPorFechaDev($FechaInicial, $FechaFinal);
...
$setSql = "SELECT creditos_garantias.socio_garantia AS 'socio',  socios.nombre,
	...
	AND creditos_garantias.estatus_actual = " . $xGarE->ESTADO_DEVUELTO .  " $ByFechas ";

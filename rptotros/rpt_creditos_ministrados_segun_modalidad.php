...
if ($fecha_inicial && $fecha_final){
	$si_es_por_fecha = " AND fecha_ministracion>='$fecha_inicial' AND fecha_ministracion<='$fecha_final' ";
}
/**
 * Filtrar si existe Modalidad de Periocidad del Credito
 */
...
$input = $_GET["out"];
	...
	AND creditos.saldo_actual>=0.01
	$si_es_caja_local
	$si_es_por_fecha
	ORDER BY creditos.periocidad, creditos.fecha_ministracion
	";
...
if ($input!=OUT_EXCEL) {
	...
	$oRpt->setSQL($setSql);
	$oRpt->setXML("../repository/report33.xml");

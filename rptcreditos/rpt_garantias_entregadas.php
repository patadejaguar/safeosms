...
//
if($si_fechas == 1){
	$es_por_fechas = " AND creditos_garantias.fecha_devolucion>='$fecha_inicial'
		AND creditos_garantias.fecha_devolucion<='$fecha_final' ";
}
...
$input = $_GET["out"];
	...
	AND creditos_garantias.estatus_actual = 3
	$es_por_fechas
	";

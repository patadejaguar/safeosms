...
//=====================================================================================================
$xHP		= new cHPage("TR.CUENTA_BANCARIA", HP_FORM);
$xQL		= new MQL();
$xLi		= new cSQLListas();
$xF			= new cFecha();
...
$xHG	= new cHGrid("iddivbancos",$xHP->getTitle());

$xHG->setSQL($xLi->getListadoDeCuentasBancarias());
$xHG->addList();
$xHG->addKey("clave");
...
var xG	= new Gen();
function jsEdit(id){
	xG.w({url:"../frmbancos/cuentas-bancarias.edit.frm.php?clave=" + id, tiny:true, callback: jsLGiddivbancos});
}
function jsAdd(){
	xG.w({url:"../frmbancos/bancos_alta_a_cuentas.frm.php?", tiny:true, callback: jsLGiddivbancos});
}
function jsDel(id){

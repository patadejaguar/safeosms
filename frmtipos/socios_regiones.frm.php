...
//=====================================================================================================
$xHP		= new cHPage("TR.Region", HP_GRID);
$xF			= new cFecha();
$xL			= new cLang();
$xTabla		= new cSocios_region();
...
//Define your grid
	...
	$mGridSQL			= "idsocios_region,descripcion_region,oficial_de_credito";//,region";
	$mGridWhere			= "";

	$mGridProp			= array(
						"idsocios_region" => "TR.CLAVE,true,120",
						"descripcion_region" => "TR.NOMBRE,true,300",
						"oficial_de_credito" => "TR.OFICIAL_DE_CREDITO,true,120",
						"region" => "TR.REGION,true,80"
						);
	//===========================================================================================================

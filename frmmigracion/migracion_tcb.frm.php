...
<title>Reportes de Migracion al Temenos Core Banking</title>
</head>
...
<fieldset>
	<legend>Reportes Exportables de Migracion.- TCB</legend>
...
<tr>
			...
			<?php ctrl_select("general_reports", " name='ereport' ", " WHERE aplica='migracion-tcb'"); ?>
			 <br />
			</fieldset>
			</td>
</tr>

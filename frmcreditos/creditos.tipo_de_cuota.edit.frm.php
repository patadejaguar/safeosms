...
//=====================================================================================================
$xHP		= new cHPage("EDITAR TIPOS_DE CUOTA", HP_FORM);
$xQL		= new MQL();
$xLi		= new cSQLListas();
$xF			= new cFecha();
...
/* ===========        FORMULARIO EDICION         ============*/
$xTabla        = new cCreditos_tipo_de_pago();
$xTabla->setData( $xTabla->query()->initByID($clave));
$xFRM    = new cHForm("frmperioflujo", "creditos.tipo_de_cuota.frm.php?action=$action");

$xFRM->setTitle($xHP->getTitle());
$xSel        = new cHSelect();

$xFRM->OHidden("idcreditos_tipo_de_pago", $xTabla->idcreditos_tipo_de_pago()->v());
$xFRM->OText("descripcion", $xTabla->descripcion()->v(), "TR.DESCRIPCION");

$xFRM->OSiNo( "TR.CON CAPITAL","con_capital", $xTabla->con_capital()->v());

...
switch ($cmd){
	case 1:
		$rs	= sendURLQuery(SAFE_HOST_URL . "frmutils/cierre_de_colocacion.frm.php?f=$fecha");
		 break;
	case 2:
		$rs	= sendURLQuery(SAFE_HOST_URL . "frmutils/cierre_de_captacion.frm.php?f=$fecha");
		break;
	case 3:
		$rs	= sendURLQuery(SAFE_HOST_URL . "frmutils/cierre_de_contabilidad.frm.php?f=$fecha");
		break;
	case 4:
		$rs	= sendURLQuery(SAFE_HOST_URL . "frmutils/cierre_de_seguimiento.frm.php?f=$fecha");
		break;
	case 5:
		$rs	= sendURLQuery(SAFE_HOST_URL . "frmutils/cierre_de_riesgos.frm.php?f=$fecha");
		break;
	case 6:
		$rs	= sendURLQuery(SAFE_HOST_URL . "frmutils/cierre_de_sistema.frm.php?f=$fecha");
		break;		
}
echo $rs;

...
//=====================================================================================================
$xHP		= new cHPage("TR.Catalogo de Monedas", HP_GRID);
$xF			= new cFecha();
	...
	$mGridProp			= array(
	"clave_de_moneda" => "Clave de Moneda,true,10",
	"nombre_de_la_moneda" => "Nombre de la Moneda,false,100",
	"quivalencia_en_moneda_local" => "Equivalencia en Moneda local,true,33",
	"pais_de_origen" => "Pais de origen,true,10"
						);
	//===========================================================================================================

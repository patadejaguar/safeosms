...
//=====================================================================================================
$xHP		= new cHPage("TR.GUARDAR TASAS DE CAPTACION", HP_FORM);
$xQL		= new MQL();
$xLi		= new cSQLListas();
$xF			= new cFecha();
...
$xFRM->OHidden("idcaptacion_tasas", "NULL");
if($producto >0){
	$xPC	= new cCaptacionProducto($producto);
	if($xPC->init() == true){
		$xFRM->OHidden("modalidad_cuenta", $xPC->getClase());
		$xFRM->OHidden("subproducto", $producto);
	} else {

...
//=====================================================================================================
$xHP		= new cHPage("TR.CODIGOS DE ERROR ", HP_REPORT);
$xL			= new cSQLListas();
$xF			= new cFecha();
$query		= new MQL();
...
$sql			= "SELECT
	`general_error_codigos`.`idgeneral_error_codigos` AS `codigo`,
	`general_error_codigos`.`description_error`       AS `descripcion`,
	`general_error_codigos`.`type_err`                AS `tipo` 
FROM
	`general_error_codigos` `general_error_codigos` ORDER BY
	`general_error_codigos`.`idgeneral_error_codigos`";
$titulo			= "";
$archivo		= "";

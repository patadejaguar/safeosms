...
//=====================================================================================================
$xHP		= new cHPage("TR.Riesgo PLD Reportados", HP_REPORT);
$xL			= new cSQLListas();
$xF			= new cFecha();
$query		= new MQL();
$xAl		= new cAml_alerts();
...
$sql		= $xlistas->getListadoDeRiesgosConfirmados($FechaInicial, $FechaFinal, false, false, false, " AND `estado_de_envio`= " . SYS_UNO);
$xT			= new cTabla($sql);

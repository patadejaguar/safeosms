...
$idpersonadocto	= parametro("idpersonadocto", 0, MQL_INT);

$xDocP			= new cPersonasDocumentacion($idpersonadocto);
if($xDocP->init() == true){
	$latitud		= $xDocP->getLatitud();
	$longitud		= $xDocP->getLongitud();
}
...
$xFRM->addHElem("<div id='map' style='min-height:600px'></div>");

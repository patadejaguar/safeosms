...
$.fn.visualize = function(options, container){
	return $(this).each(function(){
		...
		var o = $.extend({
			...
			rowFilter: '*',
			colFilter: '*',
			colors: ['#be1e2d','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744','#8900FF',
				'#00FF89', '#FF0002', '#484F4D', '#73FF00', '#0073FF', '#3AA62F', '#2F79A6', '#FF7D00', '#0091FF', '#FF0082',
				'#be1e2d','#666699','#92d5ea','#ee8310','#8d10ee','#5a3b16','#26a4ed','#f45a90','#e9e744','#8900FF',
				'#00FF89', '#FF0002', '#484F4D', '#73FF00', '#0073FF', '#3AA62F', '#2F79A6', '#FF7D00', '#0091FF', '#FF0082',
				],
